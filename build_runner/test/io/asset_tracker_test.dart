  ...
  group('AssetTracker.collectChanges()', () {
    ...
    setUp(() async {
      ...
      expect(
        updates..removeWhere(
          (location, type) =>
              location.id.package == r'$sdk' && type == ChangeType.ADD,
        ),
        isEmpty,
      );
    });
    ...
    test('Collects file edits', () async {
      ...
      expect(
        ...
        {AssetLocation.source(AssetId('a', 'web/a.txt')): ChangeType.MODIFY},
      );
    });
    ...
    test('Collects new files', () async {
      ...
      expect(
        ...
        {AssetLocation.source(AssetId('a', 'web/b.txt')): ChangeType.ADD},
      );
    });
    ...
    test('Collects deleted files', () async {
      ...
      expect(
        ...
        {AssetLocation.source(AssetId('a', 'web/a.txt')): ChangeType.REMOVE},
      );
    });
    ...
    test('Collects deleted declared outputs', () async {
      ...
      changes.removeWhere((location, type) => location.id.package == r'$sdk');
      expect(changes, {AssetLocation.source(outputId): ChangeType.REMOVE});
    });
  });
}
