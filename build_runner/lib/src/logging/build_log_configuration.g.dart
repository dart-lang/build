...
class _$BuildLogConfiguration extends BuildLogConfiguration {
  ...
  @override
  final String? singlePackageToBuild;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is BuildLogConfiguration &&
        ...
        singlePackageToBuild == other.singlePackageToBuild &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, singlePackageToBuild.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'BuildLogConfiguration')
          ...
          ..add('verbose', verbose)
          ..add('onLog', onLog)
          ..add('singlePackageToBuild', singlePackageToBuild)
...
class BuildLogConfigurationBuilder
  ...
  String? _singlePackageToBuild;
  String? get singlePackageToBuild => _$this._singlePackageToBuild;
  set singlePackageToBuild(String? singlePackageToBuild) =>
      _$this._singlePackageToBuild = singlePackageToBuild;
  ...
  BuildLogConfigurationBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _verbose = $v.verbose;
      _onLog = $v.onLog;
      _singlePackageToBuild = $v.singlePackageToBuild;
