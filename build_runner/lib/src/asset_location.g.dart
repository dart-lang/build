...
class _$AssetLocationSerializer implements StructuredSerializer<AssetLocation> {
  ...
  AssetLocation deserialize(
    ...
    final result = new AssetLocationBuilder();
...
class _$AssetLocation extends AssetLocation {
  ...
  factory _$AssetLocation([void Function(AssetLocationBuilder)? updates]) =>
      (new AssetLocationBuilder()..update(updates)).build() as _$AssetLocation;

  _$AssetLocation._({required this.id, required this.hidden}) : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'AssetLocation', 'id');
    BuiltValueNullFieldError.checkNotNull(hidden, r'AssetLocation', 'hidden');
  }
  ...
  @override
  AssetLocationBuilder toBuilder() => new AssetLocationBuilder()..replace(this);
