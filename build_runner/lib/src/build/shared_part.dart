...
class SharedPart {
  ...
  SharedPart(this.primaryInput, this.languageVersion);

  SharedPart.digestOnly(this.primaryInput, this.languageVersion)
    : _isDigestOnly = true;
  ...
  void _checkHasContent() {
    if (!hasContent) {
      throw StateError(
        'SharedPart for $primaryInput is in digest-only state. '
  ...
  void restoreContent(String content) {
    final parsed = SharedPart.parseContent(content, primaryInput);
    _imports
      ..clear()
  ...
  static SharedPart parseContent(String content, AssetId primaryInput) {
    if (content.isEmpty) {
      return SharedPart(primaryInput, null);
    }
    ...
    final result = SharedPart(primaryInput, parsedLanguageVersion);
