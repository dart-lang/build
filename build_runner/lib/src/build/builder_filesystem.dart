...
class BuilderFilesystem {
  ...
  void Function(AssetId, int, Iterable<String>)? _onUpdatePartContributions;
  ...
  void listenToPartContributions(
    void Function(AssetId, int, Iterable<String>) onUpdatePartContributions,
  ) {
