...
class Build {
    ...
    if (stepAction.isSkip) {
      ...
      switch (stepAction) {
        case StepAction.skipKeepPrevious:
          final previousResult = buildPlan.previousStepResult(buildStepId);
  ...
  Future<Iterable<AssetId>> _runPostProcessBuildStep(
    ...
    final previousResult = buildPlan.previousPostProcessStepResult(
  ...
  Future<StepAction> _computeStepAction(
    ...
    return await TimedActivity.track.runAsync(() async {
      ...
      final stepResult =
          buildPlan.previousStepResult(step) ??
  ...
  Future<bool> _hasInputChanged({
    ...
    if (buildState.isMissingSource(input)) {
      return false;
    }
  ...
  Future<void> _evaluateGlob(GlobId globId) async {
    ...
    return lazyGlobs.putIfAbsent(globId, () async {
      ...
      final previousDigest = buildPlan.previousGlobDigest(globId);
