...
class Build {
  ...
  Future<void> _updateAssetGraph(Set<AssetId> idsToCheck) async {
    changedInputs.clear();
    deletedAssets.clear();

    readerWriter.cache.invalidate(idsToCheck);
    ...
    for (final id in idsToCheck) {
      ...
      if (await readerWriter.canRead(id)) {
        exists = true;
        // An asset was an input in the previous build if it had a digest. Check
