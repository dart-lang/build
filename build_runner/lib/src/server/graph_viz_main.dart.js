// Generated by dart2js (kernel FE, full emitter), the Dart to JavaScript compiler version: 2.0.0-dev.43.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    IsolateNatives__processWorkerMessage: [function(sender, e) {
      var msg, t1, functionName, entryPoint, args, message, isSpawnUri, startPaused, replyTo, context, t2;
    ...
    }, null, null, 14, 0, null, 35, 32, 23, 24, 22, 21, 19],
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 31, 16],
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 4, 0, 2, 1],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 4, 0, 2, 1],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 30, 2, 1],
    ...
    }, "call$1", "collection___defaultHashCode$closure", 2, 0, 33, 3],
    ...
    }, "call$2", "collection___dynamicCompare$closure", 4, 0, 34, 3, 6],
    ...
    }, "call$1", "core__identityHashCode$closure", 2, 0, 10, 13],
    ...
    }, "call$2", "core__identical$closure", 4, 0, 5, 3, 6],
    Uri_base: function() {
    ...
    Comparable_compare: [function(a, b) {
      return J.compareTo$1$ns(a, b);
    }, "call$2", "core_Comparable_compare$closure", 4, 0, 35, 3, 6],
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 11, 25],
    ...
    }, null, null, 8, 0, null, 28, 29, 46, 31],
    ...
    DefaultEquality: {
      ...
      equals$2: [function(e1, e2) {
        return J.$eq$(e1, e2);
      }, "call$2", "get$equals", 4, 0, 5, 33, 34],
      hash$1: [function(_, e) {
        return J.get$hashCode$(e);
      }, "call$1", "get$hash", 2, 0, 10, 9],
      isValidKey$1: [function(o) {
        return true;
      }, "call$1", "get$isValidKey", 2, 0, 27]
    },
    IterableEquality: {
    ...
    StringScanner: {
      ...
      }, "error$2$position", "call$4$length$match$position", "call$1", "call$3$length$position", "call$2$position", "get$error", 2, 7, 29, 0, 0, 0, 37, 38, 39, 40]
    }
    ...
    "^": "",
    AssetGraph: {
      "^": "Object;_failedActions,_nodesByPackage,buildPhasesDigest,dartVersion",
    ...
    _AssetGraphDeserializer: {
      ...
      deserialize$0: function() {
        var t1, t2, t3, t4, t5, graph, packageNames, assetPaths, i, t6, packageName, t7, path, node, serializedFailedActions;
        ...
        t4 = P.String;
        t5 = P.int;
        graph = new S.AssetGraph(P.LinkedHashMap_LinkedHashMap$_empty(t5, [P.Set, N.AssetId]), P.LinkedHashMap_LinkedHashMap$_empty(t4, [P.Map, P.String, B.AssetNode]), t2, t3);
        ...
        i = 0;
        while (true) {
          t6 = t2.get$length(assetPaths);
          if (typeof t6 !== "number")
            return H.iae(t6);
          if (!(i < t6))
            break;
          packageName = t3.$index(packageNames, H.intTypeCast(t2.$index(assetPaths, i + 1)));
          t6 = C.JSInt_methods._tdivFast$1(i, 2);
          t7 = H.stringTypeCast(t2.$index(assetPaths, i));
          if (J.$gt$n($.$get$context0().style.rootLength$1(t7), 0))
            H.throwExpression(P.ArgumentError$('Asset paths must be relative, but got "' + H.S(t7) + '".'));
          t7.toString;
          path = H.stringReplaceAllUnchecked(t7, "\\", "/");
          t4.$indexSet(0, t6, new N.AssetId(packageName, $.$get$posix().normalize$1(path), null));
          i += 2;
        }
        ...
        t5 = [t5];
        t2 = graph._failedActions;
        i = 0;
        while (true) {
          t3 = t1.get$length(serializedFailedActions);
          if (typeof t3 !== "number")
            return H.iae(t3);
          if (!(i < t3))
            break;
          t2.$indexSet(0, H.intTypeCast(t1.$index(serializedFailedActions, i)), J.map$1$ax(H.subtypeCast(t1.$index(serializedFailedActions, i + 1), "$isList", t5, "$asList"), new S._AssetGraphDeserializer_deserialize_closure(this)).toSet$0(0));
          i += 2;
        }
        return graph;
      },
      _deserializeAssetNode$1: function(serializedNode) {
        ...
        switch (typeId) {
          ...
          case C._NodeType_2:
            ...
            node = new B.GeneratedAssetNode(t3, t4, t5, t6, t7, t11, t8, t2, t9, id, P.LinkedHashSet_LinkedHashSet(null, null, null, t10), P.LinkedHashSet_LinkedHashSet(null, null, null, t10), P.LinkedHashSet_LinkedHashSet(null, null, null, t10), digest);
            break;
          case C._NodeType_3:
            t2 = N.AssetId;
    ...
    GeneratedAssetNode: {
      "^": "AssetNode;phaseNumber,primaryInput,state,wasOutput,globs,inputs,previousInputsDigest,builderOptionsId,isHidden,id,primaryOutputs,outputs,anchorOutputs,lastKnownDigest",
      get$isGenerated: function() {
        return true;
      },
      toString$0: function(_) {
...
;
  ...
  $ = new Isolate();
  init.metadata = [null, "stackTrace", "error", "a", "_", "o", "b", "result", "each", "e", "invocation", "x", "node", "object", "arg", "data", "value", "sender", "key", "arg4", "element", "arg3", "arg2", "numberOfArguments", "arg1", "encodedComponent", "s", "xhr", "callback", "captureThis", "out", "arguments", "isolate", "e1", "e2", "closure", "option", "message", "length", "match", "position", "n", "serializedId", "pattern", "id", "g", "self"];
