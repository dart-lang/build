// Generated by dart2js (ast FE, full emitter), the Dart to JavaScript compiler version: 2.0.0-dev.26.0.
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _AssetGraphDeserializer: {
      ...
      deserialize$0: function() {
        ...
        if (!J.$eq$(t1.$index(0, "version"), 17))
          throw H.wrapException(new T.AssetGraphVersionException(H.intTypeCast(t1.$index(0, "version")), 17));
      ...
      _deserializeAssetNode$1: function(serializedNode) {
        ...
        switch (typeId) {
          ...
          case C._NodeType_2:
            ...
            t5 = H.intTypeCast(t1.$index(serializedNode, 9)) !== 0 || false;
    ...
    GeneratedAssetNode: {
      "^": "AssetNode;phaseNumber,primaryInput,needsUpdate,wasOutput,globs,inputs,previousInputsDigest,builderOptionsId,isHidden,id,primaryOutputs,outputs,lastKnownDigest",
      get$isGenerated: function() {
        return true;
      },
      toString$0: function(_) {
