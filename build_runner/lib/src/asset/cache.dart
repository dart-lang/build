...
/// A [RunnerAssetReader] which takes both an [AssetCache] and a
/// [RunnerAssetReader].
///
/// It will first look up values in the [AssetCache], and if not present it will
/// use the [RunnerAssetReader] and add the [Asset] to the [AssetCache].
class CachedAssetReader implements RunnerAssetReader {
