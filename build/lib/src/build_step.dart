...
abstract class BuildStep implements AssetReader, AssetWriter {
  ...
  /// A [Resolver] that can parse or resolve any Dart source code readable by
  /// this build step.
  ///
  ...
  ///
  /// A file can be read if it exists as an input or was generated by a builder
  /// that runs before the current builder.
  ///
