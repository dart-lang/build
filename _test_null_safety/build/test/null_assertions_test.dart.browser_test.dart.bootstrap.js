...
let modulePaths = {
 ...
 "test/common/message": "common/message.unsound.ddc",
 "test/null_assertions_test": "null_assertions_test.unsound.ddc",
 "test/null_assertions_test.dart.browser_test": "null_assertions_test.dart.browser_test.unsound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'null_assertions_test.dart.browser_test.digests',
...
define("null_assertions_test.dart.browser_test.dart.bootstrap", ["test/null_assertions_test.dart.browser_test", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.test__null_assertions_test$46dart$46browser_test || app.null_assertions_test$46dart$46browser_test).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "null_assertions_test.dart.browser_test.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("null_assertions_test.dart.browser_test.dart.bootstrap", {
    "null_assertions_test.dart.browser_test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
