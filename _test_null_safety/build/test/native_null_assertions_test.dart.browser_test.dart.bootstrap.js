...
let modulePaths = {
 ...
 "test/native_null_assertions_test": "native_null_assertions_test.sound.ddc",
 "test/native_null_assertions_test.dart.browser_test": "native_null_assertions_test.dart.browser_test.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'native_null_assertions_test.dart.browser_test.digests',
...
define("native_null_assertions_test.dart.browser_test.dart.bootstrap", ["test/native_null_assertions_test.dart.browser_test", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.test__native_null_assertions_test$46dart$46browser_test || app.native_null_assertions_test$46dart$46browser_test).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "native_null_assertions_test.dart.browser_test.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("native_null_assertions_test.dart.browser_test.dart.bootstrap", {
    "native_null_assertions_test.dart.browser_test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
