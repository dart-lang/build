...
let modulePaths = {
 ...
 "test/common/message": "common/message.sound.ddc",
 "test/opted_in_test": "opted_in_test.sound.ddc",
 "test/opted_in_test.dart.browser_test": "opted_in_test.dart.browser_test.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'opted_in_test.dart.browser_test.digests',
...
define("opted_in_test.dart.browser_test.dart.bootstrap", ["test/opted_in_test.dart.browser_test", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.test__opted_in_test$46dart$46browser_test || app.opted_in_test$46dart$46browser_test).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "opted_in_test.dart.browser_test.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("opted_in_test.dart.browser_test.dart.bootstrap", {
    "opted_in_test.dart.browser_test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
