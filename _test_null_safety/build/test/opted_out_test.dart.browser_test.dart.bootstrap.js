...
let modulePaths = {
 ...
 "test/opted_out_test": "opted_out_test.unsound.ddc",
 "test/opted_out_test.dart.browser_test": "opted_out_test.dart.browser_test.unsound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'opted_out_test.dart.browser_test.digests',
...
define("opted_out_test.dart.browser_test.dart.bootstrap", ["test/opted_out_test.dart.browser_test", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.test__opted_out_test$46dart$46browser_test || app.opted_out_test$46dart$46browser_test).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "opted_out_test.dart.browser_test.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("opted_out_test.dart.browser_test.dart.bootstrap", {
    "opted_out_test.dart.browser_test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
