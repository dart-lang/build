define(['dart_sdk', 'packages/async/async'], (function load__packages__stream_channel__stream_channel(dart_sdk, packages__async__async) {
  ...
  var I = [
    "org-dartlang-app:///packages/stream_channel/src/guarantee_channel.dart",
    "org-dartlang-app:///packages/stream_channel/stream_channel.dart",
    "package:stream_channel/stream_channel.dart",
    "package:stream_channel/src/guarantee_channel.dart",
    "org-dartlang-app:///packages/stream_channel/src/stream_channel_transformer.dart",
    "package:stream_channel/src/stream_channel_transformer.dart",
    "org-dartlang-app:///packages/stream_channel/src/stream_channel_controller.dart",
    "package:stream_channel/src/stream_channel_controller.dart",
    "org-dartlang-app:///packages/stream_channel/src/stream_channel_completer.dart",
    "package:stream_channel/src/stream_channel_completer.dart",
    "org-dartlang-app:///packages/stream_channel/src/multi_channel.dart",
    "package:stream_channel/src/multi_channel.dart",
    "org-dartlang-app:///packages/stream_channel/src/json_document_transformer.dart",
    "package:stream_channel/src/json_document_transformer.dart",
    "org-dartlang-app:///packages/stream_channel/src/disconnector.dart",
    "package:stream_channel/src/disconnector.dart",
    "org-dartlang-app:///packages/stream_channel/src/delegating_stream_channel.dart",
    "package:stream_channel/src/delegating_stream_channel.dart",
    "org-dartlang-app:///packages/stream_channel/src/close_guarantee_channel.dart",
  ...
  stream_channel.StreamChannelMixin$ = dart.generic(T => {
    ...
    class StreamChannelMixin extends core.Object {
      pipe(other) {
        ...
        if (other == null) dart.nullFailed(I[1], 153, 30, "other");
      ...
      transform(S, transformer) {
        ...
        if (transformer == null) dart.nullFailed(I[1], 159, 64, "transformer");
        return transformer.bind(this);
      }
      transformStream(transformer) {
        __t$StreamTransformerOfT$T().as(transformer);
        if (transformer == null) dart.nullFailed(I[1], 163, 60, "transformer");
    ...
    dart.setLibraryUri(StreamChannelMixin, I[2]);
  ...
  guarantee_channel.GuaranteeChannel$ = dart.generic(T => {
    ...
    class GuaranteeChannel extends stream_channel.StreamChannelMixin$(T) {
      ...
      get [_sink]() {
        let t0;
        return dart.test(this[__GuaranteeChannel__sink_isSet]) ? (t0 = this[__GuaranteeChannel__sink], t0) : dart.throw(new _internal.LateError.fieldNI("_sink"));
      }
      set [_sink](library$32package$58stream_channel$47src$47guarantee_channel$46dart$58$58_sink$35param) {
        if (library$32package$58stream_channel$47src$47guarantee_channel$46dart$58$58_sink$35param == null) dart.nullFailed(I[0], 20, 32, "library package:stream_channel/src/guarantee_channel.dart::_sink#param");
      ...
      get [_streamController]() {
        let t0;
        return dart.test(this[__GuaranteeChannel__streamController_isSet]) ? (t0 = this[__GuaranteeChannel__streamController], t0) : dart.throw(new _internal.LateError.fieldNI("_streamController"));
      }
      set [_streamController](library$32package$58stream_channel$47src$47guarantee_channel$46dart$58$58_streamController$35param) {
        if (library$32package$58stream_channel$47src$47guarantee_channel$46dart$58$58_streamController$35param == null) dart.nullFailed(I[0], 27, 34, "library package:stream_channel/src/guarantee_channel.dart::_streamController#param");
      ...
      static ['_#new#tearOff'](T, innerStream, innerSink, opts) {
        if (innerStream == null) dart.nullFailed(I[0], 35, 30, "innerStream");
        if (innerSink == null) dart.nullFailed(I[0], 35, 57, "innerSink");
        let allowSinkErrors = opts && 'allowSinkErrors' in opts ? opts.allowSinkErrors : true;
        if (allowSinkErrors == null) dart.nullFailed(I[0], 36, 13, "allowSinkErrors");
    ...
    dart.setLibraryUri(GuaranteeChannel, I[3]);
  ...
  guarantee_channel._GuaranteeSink$ = dart.generic(T => {
    ...
    class _GuaranteeSink extends core.Object {
      ...
      static ['_#new#tearOff'](T, _inner, _channel, opts) {
        if (_inner == null) dart.nullFailed(I[0], 114, 23, "_inner");
        if (_channel == null) dart.nullFailed(I[0], 114, 36, "_channel");
        let allowErrors = opts && 'allowErrors' in opts ? opts.allowErrors : true;
        if (allowErrors == null) dart.nullFailed(I[0], 114, 52, "allowErrors");
      ...
      addError(error, stackTrace = null) {
        if (error == null) dart.nullFailed(I[0], 129, 17, "error");
        if (dart.test(this[_closed])) dart.throw(new core.StateError.new("Cannot add event after closing."));
        if (dart.test(this[_inAddStream])) {
          dart.throw(new core.StateError.new("Cannot add event while adding stream."));
        }
      ...
      [_addError](error, stackTrace = null) {
        if (error == null) dart.nullFailed(I[0], 143, 25, "error");
      ...
      addStream(stream) {
        ...
        if (stream == null) dart.nullFailed(I[0], 161, 36, "stream");
    ...
    dart.setLibraryUri(_GuaranteeSink, I[3]);
  ...
  stream_channel.StreamChannel$ = dart.generic(T => {
    class StreamChannel extends core.Object {
      static new(stream, sink) {
        if (stream == null) dart.nullFailed(I[1], 73, 35, "stream");
        if (sink == null) dart.nullFailed(I[1], 73, 57, "sink");
      ...
      static withGuarantees(stream, sink, opts) {
        if (stream == null) dart.nullFailed(I[1], 86, 50, "stream");
        if (sink == null) dart.nullFailed(I[1], 86, 72, "sink");
        let allowSinkErrors = opts && 'allowSinkErrors' in opts ? opts.allowSinkErrors : true;
        if (allowSinkErrors == null) dart.nullFailed(I[1], 87, 17, "allowSinkErrors");
      ...
      static withCloseGuarantee(stream, sink) {
        if (stream == null) dart.nullFailed(I[1], 100, 21, "stream");
        if (sink == null) dart.nullFailed(I[1], 100, 43, "sink");
    ...
    dart.setLibraryUri(StreamChannel, I[2]);
  ...
  stream_channel._StreamChannel$ = dart.generic(T => {
    class _StreamChannel extends stream_channel.StreamChannelMixin$(T) {
      static ['_#new#tearOff'](T, stream, sink) {
        if (stream == null) dart.nullFailed(I[1], 146, 23, "stream");
        if (sink == null) dart.nullFailed(I[1], 146, 36, "sink");
        return new (stream_channel._StreamChannel$(T)).new(stream, sink);
      }
    }
    ...
    dart.setLibraryUri(_StreamChannel, I[2]);
  ...
  stream_channel_transformer.StreamChannelTransformer$ = dart.generic((S, T) => {
    ...
    class StreamChannelTransformer extends core.Object {
      ...
      static ['_#new#tearOff'](S, T, _streamTransformer, _sinkTransformer) {
        if (_streamTransformer == null) dart.nullFailed(I[4], 37, 12, "_streamTransformer");
        if (_sinkTransformer == null) dart.nullFailed(I[4], 37, 37, "_sinkTransformer");
    ...
    dart.setLibraryUri(StreamChannelTransformer, I[5]);
  ...
  stream_channel_controller.StreamChannelController$ = dart.generic(T => {
    ...
    class StreamChannelController extends core.Object {
      ...
      set [_local](library$32package$58stream_channel$47src$47stream_channel_controller$46dart$58$58_local$35param) {
        if (library$32package$58stream_channel$47src$47stream_channel_controller$46dart$58$58_local$35param == null) dart.nullFailed(I[6], 36, 31, "library package:stream_channel/src/stream_channel_controller.dart::_local#param");
      ...
      get [_foreign]() {
        let t0;
        return dart.test(this[__StreamChannelController__foreign_isSet]) ? (t0 = this[__StreamChannelController__foreign], t0) : dart.throw(new _internal.LateError.fieldNI("_foreign"));
      }
      set [_foreign](library$32package$58stream_channel$47src$47stream_channel_controller$46dart$58$58_foreign$35param) {
        if (library$32package$58stream_channel$47src$47stream_channel_controller$46dart$58$58_foreign$35param == null) dart.nullFailed(I[6], 43, 31, "library package:stream_channel/src/stream_channel_controller.dart::_foreign#param");
      ...
      static ['_#new#tearOff'](T, opts) {
        ...
        if (allowForeignErrors == null) dart.nullFailed(I[6], 55, 33, "allowForeignErrors");
        let sync = opts && 'sync' in opts ? opts.sync : false;
        if (sync == null) dart.nullFailed(I[6], 55, 65, "sync");
    ...
    dart.setLibraryUri(StreamChannelController, I[7]);
  ...
  stream_channel_completer.StreamChannelCompleter$ = dart.generic(T => {
    ...
    class StreamChannelCompleter extends core.Object {
      ...
      get [_channel]() {
        let t0;
        return dart.test(this[__StreamChannelCompleter__channel_isSet]) ? (t0 = this[__StreamChannelCompleter__channel], t0) : dart.throw(new _internal.LateError.fieldNI("_channel"));
      }
      set [_channel](library$32package$58stream_channel$47src$47stream_channel_completer$46dart$58$58_channel$35param) {
        if (library$32package$58stream_channel$47src$47stream_channel_completer$46dart$58$58_channel$35param == null) dart.nullFailed(I[8], 23, 31, "library package:stream_channel/src/stream_channel_completer.dart::_channel#param");
      ...
      static fromFuture(channelFuture) {
        if (channelFuture == null) dart.nullFailed(I[8], 36, 57, "channelFuture");
      ...
      setChannel(channel) {
        __t$StreamChannelOfT().as(channel);
        if (channel == null) dart.nullFailed(I[8], 52, 36, "channel");
      ...
      setError(error, stackTrace = null) {
        if (error == null) dart.nullFailed(I[8], 67, 24, "error");
        if (dart.test(this[_set])) dart.throw(new core.StateError.new("The channel has already been set."));
        this[_set] = true;
    ...
    dart.setLibraryUri(StreamChannelCompleter, I[9]);
  ...
  multi_channel.MultiChannel$ = dart.generic(T => {
    class MultiChannel extends core.Object {
      static new(inner) {
        if (inner == null) dart.nullFailed(I[10], 63, 47, "inner");
    ...
    dart.setLibraryUri(MultiChannel, I[11]);
    return MultiChannel;
  });
  ...
  multi_channel._MultiChannel$ = dart.generic(T => {
    ...
    class _MultiChannel extends stream_channel.StreamChannelMixin$(T) {
      ...
      static ['_#new#tearOff'](T, inner) {
        if (inner == null) dart.nullFailed(I[10], 135, 40, "inner");
        return new (multi_channel._MultiChannel$(T)).new(inner);
      }
      virtualChannel(id = null) {
        ...
        function controller$35set(controller$35param) {
          if (controller$35param == null) dart.nullFailed(I[10], 197, 37, "controller#param");
      ...
      [_closeChannel](inputId, outputId) {
        if (inputId == null) dart.nullFailed(I[10], 219, 26, "inputId");
        if (outputId == null) dart.nullFailed(I[10], 219, 39, "outputId");
    ...
    (_MultiChannel.new = function(inner) {
      ...
      this[_innerStreamSubscription] = dart.nullCheck(this[_inner]).stream.cast(core.List).listen(dart.fn(message => {
        if (message == null) dart.nullFailed(I[10], 143, 68, "message");
    ...
    dart.setLibraryUri(_MultiChannel, I[11]);
  ...
  multi_channel.VirtualChannel$ = dart.generic(T => {
    class VirtualChannel extends stream_channel.StreamChannelMixin$(T) {
      ...
      static ['_#_#tearOff'](T, _parent, id, stream, sink) {
        if (_parent == null) dart.nullFailed(I[10], 269, 25, "_parent");
        if (id == null) dart.nullFailed(I[10], 269, 39, "id");
        if (stream == null) dart.nullFailed(I[10], 269, 48, "stream");
        if (sink == null) dart.nullFailed(I[10], 269, 61, "sink");
    ...
    dart.setLibraryUri(VirtualChannel, I[11]);
  ...
  json_document_transformer._JsonDocument = class _JsonDocument extends core.Object {
    ...
    bind(channel) {
      ...
      if (channel == null) dart.nullFailed(I[12], 28, 53, "channel");
      ...
      let sink = T$.StreamSinkTransformerOfObject$String().fromHandlers({handleData: dart.fn((data, sink) => {
          if (data == null) dart.nullFailed(I[12], 31, 22, "data");
          if (sink == null) dart.nullFailed(I[12], 31, 28, "sink");
  ...
  dart.setLibraryUri(json_document_transformer._JsonDocument, I[13]);
  ...
  disconnector.Disconnector$ = dart.generic(T => {
    ...
    class Disconnector extends core.Object {
      ...
      disconnect() {
        return this[_disconnectMemo].runOnce(dart.fn(() => {
          let futures = this[_sinks][$map](T$.FutureOfvoid(), dart.fn(sink => {
            if (sink == null) dart.nullFailed(I[14], 37, 35, "sink");
            return sink[_disconnect]();
          }, __t$_DisconnectorSinkOfTToFutureOfvoid()))[$toList]();
          this[_sinks][$clear]();
      ...
      bind(channel) {
        __t$StreamChannelOfT().as(channel);
        if (channel == null) dart.nullFailed(I[14], 44, 42, "channel");
        return channel.changeSink(dart.fn(innerSink => {
          if (innerSink == null) dart.nullFailed(I[14], 45, 32, "innerSink");
    ...
    dart.setLibraryUri(Disconnector, I[15]);
  ...
  disconnector._DisconnectorSink$ = dart.generic(T => {
    ...
    class _DisconnectorSink extends core.Object {
      ...
      static ['_#new#tearOff'](T, _inner) {
        if (_inner == null) dart.nullFailed(I[14], 86, 26, "_inner");
      ...
      addError(error, stackTrace = null) {
        if (error == null) dart.nullFailed(I[14], 100, 17, "error");
        if (dart.test(this[_closed$])) dart.throw(new core.StateError.new("Cannot add event after closing."));
        if (dart.test(this[_inAddStream$])) {
          dart.throw(new core.StateError.new("Cannot add event while adding stream."));
        }
      ...
      addStream(stream) {
        __t$StreamOfT().as(stream);
        if (stream == null) dart.nullFailed(I[14], 111, 36, "stream");
        if (dart.test(this[_closed$])) dart.throw(new core.StateError.new("Cannot add stream after closing."));
        if (dart.test(this[_inAddStream$])) {
          dart.throw(new core.StateError.new("Cannot add stream while adding stream."));
        }
    ...
    dart.setLibraryUri(_DisconnectorSink, I[15]);
  ...
  delegating_stream_channel.DelegatingStreamChannel$ = dart.generic(T => {
    class DelegatingStreamChannel extends stream_channel.StreamChannelMixin$(T) {
      ...
      static ['_#new#tearOff'](T, _inner) {
        if (_inner == null) dart.nullFailed(I[16], 22, 32, "_inner");
    ...
    dart.setLibraryUri(DelegatingStreamChannel, I[17]);
  ...
  close_guarantee_channel.CloseGuaranteeChannel$ = dart.generic(T => {
    ...
    class CloseGuaranteeChannel extends stream_channel.StreamChannelMixin$(T) {
      ...
      get [_stream]() {
        let t4;
        return dart.test(this[__CloseGuaranteeChannel__stream_isSet]) ? (t4 = this[__CloseGuaranteeChannel__stream], t4) : dart.throw(new _internal.LateError.fieldNI("_stream"));
      }
      set [_stream](library$32package$58stream_channel$47src$47close_guarantee_channel$46dart$58$58_stream$35param) {
        if (library$32package$58stream_channel$47src$47close_guarantee_channel$46dart$58$58_stream$35param == null) dart.nullFailed(I[18], 19, 39, "library package:stream_channel/src/close_guarantee_channel.dart::_stream#param");
      ...
      get [_sink$]() {
        let t4;
        return dart.test(this[__CloseGuaranteeChannel__sink_isSet]) ? (t4 = this[__CloseGuaranteeChannel__sink], t4) : dart.throw(new _internal.LateError.fieldNI("_sink"));
      }
      set [_sink$](library$32package$58stream_channel$47src$47close_guarantee_channel$46dart$58$58_sink$35param) {
        if (library$32package$58stream_channel$47src$47close_guarantee_channel$46dart$58$58_sink$35param == null) dart.nullFailed(I[18], 23, 37, "library package:stream_channel/src/close_guarantee_channel.dart::_sink#param");
      ...
      static ['_#new#tearOff'](T, innerStream, innerSink) {
        if (innerStream == null) dart.nullFailed(I[18], 31, 35, "innerStream");
        if (innerSink == null) dart.nullFailed(I[18], 31, 62, "innerSink");
    ...
    dart.setLibraryUri(CloseGuaranteeChannel, I[19]);
  ...
  close_guarantee_channel._CloseGuaranteeStream$ = dart.generic(T => {
    class _CloseGuaranteeStream extends async.Stream$(T) {
      static ['_#new#tearOff'](T, _inner, _channel) {
        if (_inner == null) dart.nullFailed(I[18], 48, 30, "_inner");
        if (_channel == null) dart.nullFailed(I[18], 48, 43, "_channel");
    ...
    dart.setLibraryUri(_CloseGuaranteeStream, I[19]);
  ...
  close_guarantee_channel._CloseGuaranteeSink$ = dart.generic(T => {
    class _CloseGuaranteeSink extends stream_sink.DelegatingStreamSink$(T) {
      static ['_#new#tearOff'](T, inner, _channel) {
        if (inner == null) dart.nullFailed(I[18], 77, 37, "inner");
        if (_channel == null) dart.nullFailed(I[18], 77, 49, "_channel");
    ...
    dart.setLibraryUri(_CloseGuaranteeSink, I[19]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":