define(['dart_sdk'], (function load__packages__collection__src__iterable_zip(dart_sdk) {
  ...
  iterable_zip.IterableZip$ = dart.generic(T => {
    ...
    class IterableZip extends collection.IterableBase$(core.List$(T)) {
      ...
      get iterator() {
        let iterators = this[_iterables][$map](__t$IteratorOfT(), dart.fn(x => {
          if (x == null) dart.nullFailed(I[0], 25, 37, "x");
          return x[$iterator];
        }, __t$IterableOfTToIteratorOfT()))[$toList]({growable: false});
  ...
  iterable_zip._IteratorZip$ = dart.generic(T => {
    ...
    class _IteratorZip extends core.Object {
      ...
      moveNext() {
        ...
        this[_current] = __t$ListOfT().generate(this[_iterators][$length], dart.fn(i => {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["iterable_zip.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAwBQ,wBAAY,AAAW,AAAuB,0CAAnB,QAAC;;AAAM,gBAAA,AAAE,EAAD;gEAA4B;AACnE,cAAO,iCAAgB,SAAS;MAClC;;gCARkC;;MAAwB,mBAAE,SAAS;AAArE;;IAAqE;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAmBnE,sBAAI,AAAW,6BAAS,MAAO;AAC/B,iBAAS,IAAI,GAAG,AAAE,CAAD,gBAAG,AAAW,4BAAQ,IAAA,AAAC,CAAA;AACtC,yBAAK,AAAU,AAAI,wBAAH,CAAC;AACA,YAAf,iBAAW;AACX,kBAAO;;;AAIS,QADpB,iBAAgB,uBAAS,AAAW,2BAAQ,QAAC;;AAAM,gBAAA,AAAU,AAAI,yBAAH,CAAC;qCACjD;AACd,cAAO;MACT;;;AAGuB;4BAAa,WAAM,wBAAW;MAAc;;iCAjBpC;;MAFtB;MAE8C,mBAAE,SAAS","file":"iterable_zip.unsound.ddc.js"}');
  // Exports:
  return {
