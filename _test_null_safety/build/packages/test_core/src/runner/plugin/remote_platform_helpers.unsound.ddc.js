define(['dart_sdk', 'packages/test_api/backend', 'packages/test_api/src/backend/stack_trace_formatter'], (function load__packages__test_core__src__runner__plugin__remote_platform_helpers(dart_sdk, packages__test_api__backend, packages__test_api__src__backend__stack_trace_formatter) {
  ...
  var I = ["org-dartlang-app:///packages/test_core/src/runner/plugin/remote_platform_helpers.dart"];
  remote_platform_helpers.serializeSuite = function serializeSuite(getMain, opts) {
    if (getMain == null) dart.nullFailed(I[0], 28, 59, "getMain");
    let hidePrints = opts && 'hidePrints' in opts ? opts.hidePrints : true;
    if (hidePrints == null) dart.nullFailed(I[0], 29, 15, "hidePrints");
  ...
  remote_platform_helpers.setStackTraceMapper = function setStackTraceMapper(mapper) {
    if (mapper == null) dart.nullFailed(I[0], 44, 43, "mapper");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["remote_platform_helpers.dart"],"names":[],"mappings":";;;;;;;;;;;;;;mEA2B0D;;QAC5C;;QAGF;AACR,UAAe,sCACb,OAAO,eACK,UAAU,cACV,UAAU;EACvB;6EAOqC;;AACpC,oBAAgC;AACpC,QAAI,AAAU,SAAD;AAE0D,MADrE,WAAM,wBACF;;AAG6B,IAAnC,AAAU,SAAD,oBAAmB,MAAM;EACpC","file":"remote_platform_helpers.unsound.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=remote_platform_helpers.unsound.ddc.js.map
