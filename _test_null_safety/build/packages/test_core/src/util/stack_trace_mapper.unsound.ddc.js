define(['dart_sdk', 'packages/source_maps/builder', 'packages/source_map_stack_trace/source_map_stack_trace', 'packages/test_api/src/backend/stack_trace_formatter'], (function load__packages__test_core__src__util__stack_trace_mapper(dart_sdk, packages__source_maps__builder, packages__source_map_stack_trace__source_map_stack_trace, packages__test_api__src__backend__stack_trace_formatter) {
  ...
  var I = [
    "org-dartlang-app:///packages/test_core/src/util/stack_trace_mapper.dart",
    "package:test_core/src/util/stack_trace_mapper.dart"
  ];
  ...
  stack_trace_mapper$.JSStackTraceMapper = class JSStackTraceMapper extends stack_trace_mapper.StackTraceMapper {
    static ['_#new#tearOff'](_mapContents, opts) {
      if (_mapContents == null) dart.nullFailed(I[0], 29, 27, "_mapContents");
    ...
    mapStackTrace(trace) {
      let t0;
      if (trace == null) dart.nullFailed(I[0], 37, 39, "trace");
    ...
    static _serializePackageConfigMap(packageConfigMap) {
      ...
      return packageConfigMap[$map](core.String, core.String, dart.fn((key, value) => {
        if (key == null) dart.nullFailed(I[0], 72, 34, "key");
        if (value == null) dart.nullFailed(I[0], 72, 39, "value");
        return new (T.MapEntryOfString$String()).__(key, dart.str(value));
      }, T.StringAndUriToMapEntryOfString$String()));
    }
    static _deserializePackageConfigMap(serialized) {
      if (serialized == null) return null;
      return serialized[$map](core.String, core.Uri, dart.fn((key, value) => {
        if (key == null) dart.nullFailed(I[0], 80, 28, "key");
        if (value == null) dart.nullFailed(I[0], 80, 33, "value");
        return new (T.MapEntryOfString$Uri()).__(key, core.Uri.parse(value));
      }, T.StringAndStringToMapEntryOfString$Uri()));
    }
  };
  ...
  dart.setLibraryUri(stack_trace_mapper$.JSStackTraceMapper, I[1]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["stack_trace_mapper.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;kBAoCsC;;;AAC9B,qBAAmB,KAAT,gBAAS,aAAT,iBAAa,qBAAc,8BAAsB;AAC/D,YAAc,sCAAc,OAAO,EAAE,KAAK,eAC1B,4BAAsB;IACxC;;;AAKE,YAAO,6CACL,eAAe,qBACf,8CAAW,OAAU,oBACrB,oBAAoB,kEAA2B,oBAC/C,8CAAU,OAAS;IAEvB;uBAI0C;AACxC,UAAI,AAAW,UAAD,UAAU,MAAO;AAC3B,yBAAe,oEACiB,AAAQ,YAAvC,AAAU,UAAA,QAAC;AAEhB,YAAO,gDAA6C,eAA1B,AAAU,UAAA,QAAC,2BACpB,eAA4B,eAAtB,AAAU,UAAA,QAAC,0BAClB,YAAY,UACZ,eAA2B,eAArB,AAAU,UAAA,QAAC;IACnC;sCAKsB;AACpB,UAAI,AAAiB,gBAAD,UAAU,MAAO;AACrC,YAAO,AAAiB,iBAAD,iCAAK,SAAC,KAAK;;;AAAU,oDAAS,GAAG,EAAU,SAAN,KAAK;;IACnE;wCAKyB;AACvB,UAAI,AAAW,UAAD,UAAU,MAAO;AAC/B,YAAO,AAAW,WAAD,8BAAK,SAAC,KAAK;;;AAAU,iDAAS,GAAG,EAAM,eAAM,KAAK;;IACrE;;yDApDwB;;QACd;QAA0B;QAAiB;IAf5C;IAce;IAEV,gBAAE,MAAM;IACJ,oBAAE,UAAU;IACf,iBAAE,OAAO","file":"stack_trace_mapper.unsound.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=stack_trace_mapper.unsound.ddc.js.map
