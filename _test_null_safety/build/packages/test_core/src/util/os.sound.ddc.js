define(['dart_sdk', 'packages/path/path', 'packages/test_api/src/backend/closed_exception'], (function load__packages__test_core__src__util__os(dart_sdk, packages__path__path, packages__test_api__src__backend__closed_exception) {
  ...
  var I = ["package:test_core/src/util/print_sink.dart"];
  dart.defineLazy(os, {
    ...
    /*os.currentOSGuess*/get currentOSGuess() {
      return dart.fn(() => {
        if (path.style[$_equals](style.Style.url)) return operating_system.OperatingSystem.none;
        if (path.style[$_equals](style.Style.windows)) return operating_system.OperatingSystem.windows;
        if (os._macOSDirectories[$any](dart.bind(path.current, $startsWith))) return operating_system.OperatingSystem.macOS;
  ...
  dart.setLibraryUri(print_sink.PrintSink, I[0]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["os.dart","print_sink.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;MAUM,oBAAiB;YAAG,iCACxB,iBACA,YACA,YACA,WACA;;MASoB,iBAAc;YAAI,AAKtC;AAJA,YAAM,AAAM,qBAAW,kBAAK,MAAuB;AACnD,YAAM,AAAM,qBAAW,sBAAS,MAAuB;AACvD,YAAI,AAAkB,2BAAc,UAAR,6BAAqB,MAAuB;AACxE,cAAuB;;;;;;;UCpBJ;AACC,MAAlB,AAAQ,oBAAM,GAAG;AACT,MAAR;IACF;aAGuB,SAAiB;AACF,MAApC,AAAQ,uBAAS,OAAO,EAAE,SAAS;AAC3B,MAAR;IACF;kBAGuB;AACU,MAA/B,AAAQ,4BAAc,QAAQ;AACtB,MAAR;IACF;YAGsB;;AACM,MAA1B,AAAQ,uBAAY,KAAJ,GAAG,EAAH,aAAO;AACf,MAAR;IACF;;AAIE,UAAc,AAAC,SAAT,0BAAkB;AACR,QAAd,WAAM;AACS,QAAf,AAAQ;;IAEZ;;;;;;IAhCM,gBAAU;;EAiClB","file":"os.sound.ddc.js"}');
  // Exports:
  return {
    src__util__os: os,
...
//# sourceMappingURL=os.sound.ddc.js.map
