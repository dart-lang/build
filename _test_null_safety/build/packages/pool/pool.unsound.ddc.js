define(['dart_sdk', 'packages/async/async', 'packages/stack_trace/src/chain'], (function load__packages__pool__pool(dart_sdk, packages__async__async, packages__stack_trace__src__chain) {
  ...
  pool.Pool = class Pool extends core.Object {
    ...
    static ['_#new#tearOff'](_maxAllocatedResources, opts) {
      if (_maxAllocatedResources == null) dart.nullFailed(I[0], 81, 13, "_maxAllocatedResources");
    ...
    withResource(T, callback) {
      if (callback == null) dart.nullFailed(I[0], 120, 52, "callback");
    ...
    forEach(S, T, elements, action, opts) {
      if (elements == null) dart.nullFailed(I[0], 154, 19, "elements");
      if (action == null) dart.nullFailed(I[0], 154, 60, "action");
      let onError = opts && 'onError' in opts ? opts.onError : null;
      onError == null ? onError = dart.fn((item, e, s) => {
        if (e == null) dart.nullFailed(I[0], 156, 24, "e");
        if (s == null) dart.nullFailed(I[0], 156, 27, "s");
        return true;
      }, dart.fnType(core.bool, [S, core.Object, core.StackTrace])) : null;
      ...
      function controller$35set(controller$35param) {
        if (controller$35param == null) dart.nullFailed(I[0], 161, 30, "controller#param");
      ...
      let iterator = null;
      let iterator$35isSet = false;
      function iterator$35get() {
        return iterator$35isSet ? iterator : dart.throw(new _internal.LateError.localNI("iterator"));
      }
      dart.fn(iterator$35get, dart.fnType(core.Iterator$(S), []));
      function iterator$35set(iterator$35param) {
        if (iterator$35param == null) dart.nullFailed(I[0], 163, 22, "iterator#param");
        iterator$35isSet = true;
        return iterator = iterator$35param;
      }
      dart.fn(iterator$35set, dart.fnType(dart.dynamic, [core.Iterator$(S)]));
      const run = _ => {
        if (_ == null) dart.nullFailed(I[0], 165, 26, "_");
        return async.async(dart.void, (function* run() {
          while (dart.test(iterator$35get().moveNext())) {
            ...
            try {
              ...
              if (core.Object.is(e)) {
                if (dart.test(dart.nullCheck(onError)(current, e, stack))) {
      ...
      const onListen = () => {
        ...
        let futures = T$.IterableOfFutureOfvoid().generate(this[_maxAllocatedResources$], dart.fn(i => {
          if (i == null) dart.nullFailed(I[0], 201, 36, "i");
          return this.withResource(dart.void, dart.fn(() => run(i), T$.VoidToFutureOfvoid()));
        }, T$.intToFutureOfvoid()));
        doneFuture = async.Future.wait(dart.void, futures, {eagerError: true}).then(dart.void, dart.fn(_ => {
          if (_ == null) dart.nullFailed(I[0], 203, 24, "_");
    ...
    [_onResourceReleased]() {
      ...
      if (dart.test(this[_requestedResources][$isNotEmpty])) {
        ...
        this[_allocatedResources] = dart.notNull(this[_allocatedResources]) - 1;
        if (dart.test(this.isClosed) && this[_allocatedResources] === 0) dart.nullCheck(this[_closeGroup]).close();
      }
    }
    [_onResourceReleaseAllowed](onRelease) {
      if (onRelease == null) dart.nullFailed(I[0], 275, 45, "onRelease");
      this[_resetTimer]();
      if (dart.test(this[_requestedResources][$isNotEmpty])) {
        let pending = this[_requestedResources].removeFirst();
    ...
    [_runOnRelease](onRelease) {
      if (onRelease == null) dart.nullFailed(I[0], 297, 49, "onRelease");
      async.Future.sync(onRelease).then(core.Null, dart.fn(value => {
        ...
        if (error == null) dart.nullFailed(I[0], 300, 27, "error");
        if (stackTrace == null) dart.nullFailed(I[0], 300, 45, "stackTrace");
  ...
  pool.PoolResource = class PoolResource extends core.Object {
    static ['_#_#tearOff'](_pool) {
      if (_pool == null) dart.nullFailed(I[0], 346, 23, "_pool");
    ...
    allowRelease(onRelease) {
      if (onRelease == null) dart.nullFailed(I[0], 370, 32, "onRelease");
      if (dart.test(this[_released])) {
        dart.throw(new core.StateError.new("A PoolResource may only be released once."));
      }
      this[_released] = true;
  ...
  }, '{"version":3,"sourceRoot":"","sources":