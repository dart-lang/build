define(['dart_sdk', 'packages/collection/collection', 'packages/boolean_selector/boolean_selector', 'packages/collection/src/canonicalized_map', 'packages/source_span/source_span', 'packages/string_scanner/src/charcode', 'packages/stack_trace/src/chain'], (function load__packages__test_api__src__backend__closed_exception(dart_sdk, packages__collection__collection, packages__boolean_selector__boolean_selector, packages__collection__src__canonicalized_map, packages__source_span__source_span, packages__string_scanner__src__charcode, packages__stack_trace__src__chain) {
  ...
  var T$ = {
    ...
    PlatformSelectorL: () => (T$.PlatformSelectorL = dart.constFn(dart.legacy(platform_selector.PlatformSelector)))(),
    MetadataL: () => (T$.MetadataL = dart.constFn(dart.legacy(metadata$.Metadata)))(),
    ...
    BooleanSelectorL: () => (T$.BooleanSelectorL = dart.constFn(dart.legacy(boolean_selector.BooleanSelector)))(),
    ...
    RuntimeL: () => (T$.RuntimeL = dart.constFn(dart.legacy(runtime$.Runtime)))(),
    ...
    EmptyUnmodifiableSetOfStringL: () => (T$.EmptyUnmodifiableSetOfStringL = dart.constFn(empty_unmodifiable_set.EmptyUnmodifiableSet$(T$.StringL())))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.constMap(T$.PlatformSelectorL(), T$.MetadataL(), []);
    },
    get C2() {
      return C[2] = dart.constMap(T$.BooleanSelectorL(), T$.MetadataL(), []);
    },
    get C3() {
    ...
    get C10() {
      return C[10] = dart.constList([C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6, C[7] || CT.C7, C[8] || CT.C8, C[9] || CT.C9], T$.RuntimeL());
    },
    get C11() {
    ...
    get C16() {
      return C[16] = dart.constList([C[11] || CT.C11, C[12] || CT.C12, C[13] || CT.C13, C[14] || CT.C14, C[15] || CT.C15], T$.OperatingSystemL());
    },
    get C19() {
      return C[19] = dart.constList([], T$.StringL());
    },
    get C18() {
    ...
    get C30() {
      return C[30] = dart.const({
        __proto__: T$.EmptyUnmodifiableSetOfStringL().prototype
      });
    },
    get C31() {
  ...
  var I = [
    "org-dartlang-app:///packages/test_api/src/backend/metadata.dart",
    "package:test_api/src/backend/metadata.dart",
    "org-dartlang-app:///packages/test_api/src/backend/util/pretty_print.dart",
    "org-dartlang-app:///packages/test_api/src/backend/suite_platform.dart",
    "package:test_api/src/backend/suite_platform.dart",
    "org-dartlang-app:///packages/test_api/src/backend/runtime.dart",
    "package:test_api/src/backend/runtime.dart",
    "org-dartlang-app:///packages/test_api/src/backend/operating_system.dart",
    "package:test_api/src/backend/operating_system.dart",
    "org-dartlang-app:///packages/test_api/src/backend/platform_selector.dart",
    "package:test_api/src/backend/platform_selector.dart",
    "org-dartlang-app:///packages/test_api/src/backend/configuration/timeout.dart",
    "package:test_api/src/backend/configuration/timeout.dart",
    "package:test_api/src/backend/configuration/skip.dart",
    "org-dartlang-app:///packages/test_api/src/backend/group.dart",
    "package:test_api/src/backend/group.dart",
    "org-dartlang-app:///packages/test_api/src/backend/test.dart",
    "package:test_api/src/backend/test.dart",
    "org-dartlang-app:///packages/test_api/src/backend/suite.dart",
    "package:test_api/src/backend/suite.dart",
    "package:test_api/src/backend/live_test.dart",
    "org-dartlang-app:///packages/test_api/src/backend/state.dart",
    "package:test_api/src/backend/state.dart",
    "org-dartlang-app:///packages/test_api/src/backend/message.dart",
    ...
    "org-dartlang-app:///packages/test_api/src/backend/declarer.dart",
    "package:test_api/src/backend/declarer.dart",
    "org-dartlang-app:///packages/test_api/src/backend/invoker.dart",
    "package:test_api/src/backend/invoker.dart",
    "org-dartlang-app:///packages/test_api/src/backend/live_test_controller.dart",
  ...
  metadata$.Metadata = class Metadata extends core.Object {
    ...
    static _parseOnPlatform(onPlatform) {
      ...
      onPlatform[$forEach](dart.fn((platform, metadata) => {
        if (platform == null) dart.nullFailed(I[0], 81, 25, "platform");
    ...
    static _parsePlatformOptions(platform, metadata) {
      let t1;
      if (platform == null) dart.nullFailed(I[0], 96, 14, "platform");
      if (metadata == null) dart.nullFailed(I[0], 96, 38, "metadata");
      let timeout = null;
      let skip = null;
    ...
    static new(opts) {
      ...
      let merged = forTag[$keys][$toList]()[$fold](metadata$.Metadata, empty, dart.fn((merged, selector) => {
        if (merged == null) dart.nullFailed(I[0], 184, 61, "merged");
        if (selector == null) dart.nullFailed(I[0], 184, 69, "selector");
    ...
    [_validateTags]() {
      let invalidTags = this.tags[$where](dart.fn(tag => {
        if (tag == null) dart.nullFailed(I[0], 292, 17, "tag");
        return !tag[$contains](identifier_regex.anchoredHyphenatedIdentifier);
      }, T$.StringTobool()))[$map](core.String, dart.fn(tag => {
        if (tag == null) dart.nullFailed(I[0], 293, 15, "tag");
        return "\"" + dart.str(tag) + "\"";
      }, T$.StringToString()))[$toList]();
      if (dart.test(invalidTags[$isEmpty])) return;
      dart.throw(new core.ArgumentError.new("Invalid " + dart.str(pretty_print.pluralize("tag", invalidTags[$length])) + " " + dart.str(pretty_print.toSentence(invalidTags)) + ". Tags must be (optionally hyphenated) " + "Dart identifiers."));
    }
    validatePlatformSelectors(validVariables) {
      if (validVariables == null) dart.nullFailed(I[0], 306, 46, "validVariables");
      this.testOn.validate(validVariables);
      this.onPlatform[$forEach](dart.fn((selector, metadata) => {
        if (selector == null) dart.nullFailed(I[0], 308, 25, "selector");
        if (metadata == null) dart.nullFailed(I[0], 308, 35, "metadata");
    ...
    merge(other) {
      ...
      if (other == null) dart.nullFailed(I[0], 319, 27, "other");
      return metadata$.Metadata.new({testOn: this.testOn.intersection(other.testOn), timeout: this.timeout.merge(other.timeout), skip: (t1 = other[_skip], t1 == null ? this[_skip] : t1), skipReason: (t1$ = other.skipReason, t1$ == null ? this.skipReason : t1$), verboseTrace: (t1$0 = other[_verboseTrace], t1$0 == null ? this[_verboseTrace] : t1$0), chainStackTraces: (t1$1 = other[_chainStackTraces], t1$1 == null ? this[_chainStackTraces] : t1$1), retry: (t1$2 = other[_retry], t1$2 == null ? this[_retry] : t1$2), tags: this.tags.union(other.tags), onPlatform: functions.mergeMaps(platform_selector.PlatformSelector, metadata$.Metadata, this.onPlatform, other.onPlatform, {value: dart.fn((metadata1, metadata2) => {
            if (metadata1 == null) dart.nullFailed(I[0], 329, 19, "metadata1");
            if (metadata2 == null) dart.nullFailed(I[0], 329, 30, "metadata2");
            ...
            if (metadata1 == null) dart.nullFailed(I[0], 331, 19, "metadata1");
            if (metadata2 == null) dart.nullFailed(I[0], 331, 30, "metadata2");
            return metadata1.merge(metadata2);
    ...
    forPlatform(platform) {
      if (platform == null) dart.nullFailed(I[0], 375, 38, "platform");
      if (dart.test(this.onPlatform[$isEmpty])) return this;
      let metadata = this;
      this.onPlatform[$forEach](dart.fn((platformSelector, platformMetadata) => {
        if (platformSelector == null) dart.nullFailed(I[0], 379, 25, "platformSelector");
        if (platformMetadata == null) dart.nullFailed(I[0], 379, 43, "platformMetadata");
    ...
    serialize() {
      ...
      this.onPlatform[$forEach](dart.fn((key, value) => {
        if (key == null) dart.nullFailed(I[0], 391, 25, "key");
        if (value == null) dart.nullFailed(I[0], 391, 30, "value");
      ...
      return new (T$.IdentityMapOfString$dynamic()).from(["testOn", dart.equals(this.testOn, platform_selector.PlatformSelector.all) ? null : dart.toString(this.testOn), "timeout", this[_serializeTimeout](this.timeout), "skip", this[_skip], "skipReason", this.skipReason, "verboseTrace", this[_verboseTrace], "chainStackTraces", this[_chainStackTraces], "retry", this[_retry], "tags", this.tags[$toList](), "onPlatform", serializedOnPlatform, "forTag", this.forTag[$map](core.String, T$.MapOfString$dynamic(), dart.fn((selector, metadata) => {
          if (selector == null) dart.nullFailed(I[0], 405, 29, "selector");
          if (metadata == null) dart.nullFailed(I[0], 405, 39, "metadata");
    ...
    [_serializeTimeout](timeout) {
      let t1;
      if (timeout == null) dart.nullFailed(I[0], 412, 37, "timeout");
  ...
  pretty_print.pluralize = function pluralize(name, number, opts) {
    if (name == null) dart.nullFailed(I[2], 9, 25, "name");
    if (number == null) dart.nullFailed(I[2], 9, 35, "number");
  ...
  pretty_print.toSentence = function toSentence(iter, opts) {
    if (iter == null) dart.nullFailed(I[2], 20, 28, "iter");
    let conjunction = opts && 'conjunction' in opts ? opts.conjunction : "and";
    if (conjunction == null) dart.nullFailed(I[2], 20, 42, "conjunction");
  ...
  pretty_print.niceDuration = function niceDuration(duration) {
    if (duration == null) dart.nullFailed(I[2], 29, 30, "duration");
  ...
  suite_platform.SuitePlatform = class SuitePlatform extends core.Object {
    ...
    static ['_#new#tearOff'](runtime, opts) {
      if (runtime == null) dart.nullFailed(I[3], 27, 22, "runtime");
      let os = opts && 'os' in opts ? opts.os : C[3] || CT.C3;
      if (os == null) dart.nullFailed(I[3], 28, 13, "os");
      let inGoogle = opts && 'inGoogle' in opts ? opts.inGoogle : false;
      if (inGoogle == null) dart.nullFailed(I[3], 28, 45, "inGoogle");
      return new suite_platform.SuitePlatform.new(runtime, {os: os, inGoogle: inGoogle});
    }
    static deserialize(serialized) {
      if (serialized == null) dart.nullFailed(I[3], 36, 44, "serialized");
  ...
  dart.setLibraryUri(suite_platform.SuitePlatform, I[4]);
  ...
  runtime$.Runtime = class Runtime extends core.Object {
    ...
    static ['_#new#tearOff'](name, identifier, opts) {
      if (name == null) dart.nullFailed(I[5], 76, 22, "name");
      if (identifier == null) dart.nullFailed(I[5], 76, 33, "identifier");
      let isDartVM = opts && 'isDartVM' in opts ? opts.isDartVM : false;
      if (isDartVM == null) dart.nullFailed(I[5], 77, 13, "isDartVM");
      let isBrowser = opts && 'isBrowser' in opts ? opts.isBrowser : false;
      if (isBrowser == null) dart.nullFailed(I[5], 78, 12, "isBrowser");
      let isJS = opts && 'isJS' in opts ? opts.isJS : false;
      if (isJS == null) dart.nullFailed(I[5], 79, 12, "isJS");
      let isBlink = opts && 'isBlink' in opts ? opts.isBlink : false;
      if (isBlink == null) dart.nullFailed(I[5], 80, 12, "isBlink");
      let isHeadless = opts && 'isHeadless' in opts ? opts.isHeadless : false;
      if (isHeadless == null) dart.nullFailed(I[5], 81, 12, "isHeadless");
    ...
    static ['_#_child#tearOff'](name, identifier, parent) {
      if (name == null) dart.nullFailed(I[5], 84, 23, "name");
      if (identifier == null) dart.nullFailed(I[5], 84, 34, "identifier");
      if (parent == null) dart.nullFailed(I[5], 84, 59, "parent");
      return new runtime$.Runtime._child(name, identifier, parent);
    }
    static deserialize(serialized) {
      if (serialized == null) dart.nullFailed(I[5], 93, 38, "serialized");
      if (typeof serialized == 'string') {
        return runtime$.Runtime.builtIn[$firstWhere](dart.fn(platform => {
          if (platform == null) dart.nullFailed(I[5], 96, 24, "platform");
          return platform.identifier == serialized;
        }, T$.RuntimeTobool()));
      }
      let map = core.Map.as(serialized);
    ...
    extend(name, identifier) {
      if (name == null) dart.nullFailed(I[5], 146, 25, "name");
      if (identifier == null) dart.nullFailed(I[5], 146, 38, "identifier");
  ...
  dart.setLibraryUri(runtime$.Runtime, I[6]);
  ...
  operating_system.OperatingSystem = class OperatingSystem extends core.Object {
    ...
    static find(identifier) {
      if (identifier == null) dart.nullFailed(I[7], 44, 38, "identifier");
      return operating_system.OperatingSystem.all[$firstWhere](dart.fn(platform => {
        if (platform == null) dart.nullFailed(I[7], 45, 23, "platform");
        return platform.identifier == identifier;
      }, T$.OperatingSystemTobool()), {orElse: dart.fn(() => operating_system.OperatingSystem.none, T$.VoidToOperatingSystem())});
    }
    static findByIoName(name) {
      if (name == null) dart.nullFailed(I[7], 52, 46, "name");
      switch (name) {
        case "windows":
          {
    ...
    static ['_#_#tearOff'](name, identifier) {
      if (name == null) dart.nullFailed(I[7], 78, 32, "name");
      if (identifier == null) dart.nullFailed(I[7], 78, 43, "identifier");
  ...
  dart.setLibraryUri(operating_system.OperatingSystem, I[8]);
  ...
  platform_selector.PlatformSelector = class PlatformSelector extends core.Object {
    ...
    validate(validVariables) {
      if (validVariables == null) dart.nullFailed(I[9], 68, 29, "validVariables");
      if (this === platform_selector.PlatformSelector.all) return;
      platform_selector.PlatformSelector._wrapFormatException(dart.void, dart.fn(() => this[_inner].validate(dart.fn(name => {
        if (name == null) dart.nullFailed(I[9], 72, 32, "name");
        return dart.test(platform_selector._universalValidVariables.contains(name)) || dart.test(validVariables.contains(name));
      }, T$.StringTobool())), T$.VoidTovoid()), this[_span$]);
    }
    evaluate(platform) {
      if (platform == null) dart.nullFailed(I[9], 79, 31, "platform");
      return this[_inner].evaluate(dart.fn(variable => {
        let t2;
        if (variable == null) dart.nullFailed(I[9], 80, 36, "variable");
    ...
    intersection(other) {
      if (other == null) dart.nullFailed(I[9], 105, 50, "other");
  ...
  dart.setLibraryUri(platform_selector.PlatformSelector, I[10]);
  ...
  timeout$.Timeout = class Timeout extends core.Object {
    ...
    static parse(timeout) {
      if (timeout == null) dart.nullFailed(I[11], 71, 32, "timeout");
      ...
      while (true) {
        ...
        microseconds = microseconds + dart.notNull(timeout$.Timeout._microsecondsFor(number, dart.nullCheck(dart.nullCheck(scanner.lastMatch)._get(0))));
    ...
    static _microsecondsFor(number, unit) {
      if (number == null) dart.nullFailed(I[11], 109, 41, "number");
      if (unit == null) dart.nullFailed(I[11], 109, 56, "unit");
      switch (unit) {
        case "d":
          {
    ...
    merge(other) {
      if (other == null) dart.nullFailed(I[11], 134, 25, "other");
    ...
    apply(base) {
      let t3;
      if (base == null) dart.nullFailed(I[11], 144, 28, "base");
      if (this._equals(timeout$.Timeout.none)) return null;
      t3 = this.duration;
      return t3 == null ? base['*'](dart.nullCheck(this.scaleFactor)) : t3;
    }
    get hashCode() {
      return (dart.notNull(dart.hashCode(this.duration)) ^ 5 * dart.notNull(dart.hashCode(this.scaleFactor))) >>> 0;
    }
    _equals(other) {
      if (other == null) return false;
  ...
  dart.setLibraryUri(timeout$.Timeout, I[12]);
  ...
  dart.setLibraryUri(skip$.Skip, I[13]);
  ...
  group$.Group = class Group extends core.Object {
    ...
    static ['_#root#tearOff'](entries, opts) {
      if (entries == null) dart.nullFailed(I[14], 29, 35, "entries");
    ...
    get testCount() {
      ...
      this[_testCount] = this.entries[$fold](core.int, 0, dart.fn((count, entry) => {
        if (count == null) dart.nullFailed(I[14], 46, 13, "count");
        if (entry == null) dart.nullFailed(I[14], 46, 20, "entry");
        return dart.notNull(count) + dart.notNull(group$.Group.is(entry) ? entry.testCount : 1);
      }, T$.intAndGroupEntryToint()));
      return dart.nullCheck(this[_testCount]);
    }
    static ['_#new#tearOff'](name, entries, opts) {
      if (name == null) dart.nullFailed(I[14], 52, 14, "name");
      if (entries == null) dart.nullFailed(I[14], 52, 41, "entries");
      let metadata = opts && 'metadata' in opts ? opts.metadata : null;
    ...
    forPlatform(platform) {
      if (platform == null) dart.nullFailed(I[14], 58, 36, "platform");
      if (!dart.test(this.metadata.testOn.evaluate(platform))) return null;
      let newMetadata = this.metadata.forPlatform(platform);
      let filtered = this[_map](dart.fn(entry => {
        if (entry == null) dart.nullFailed(I[14], 61, 26, "entry");
        return entry.forPlatform(platform);
      }, T$.GroupEntryToGroupEntryN()));
    ...
    filter(callback) {
      if (callback == null) dart.nullFailed(I[14], 71, 37, "callback");
      let filtered = this[_map](dart.fn(entry => {
        if (entry == null) dart.nullFailed(I[14], 72, 26, "entry");
        return entry.filter(callback);
      }, T$.GroupEntryToGroupEntryN()));
      if (dart.test(filtered[$isEmpty]) && dart.test(this.entries[$isNotEmpty])) return null;
    ...
    [_map](callback) {
      if (callback == null) dart.nullFailed(I[14], 84, 58, "callback");
      return this.entries[$map](T$.GroupEntryN(), dart.fn(entry => {
        if (entry == null) dart.nullFailed(I[14], 86, 15, "entry");
        return callback(entry);
      }, T$.GroupEntryToGroupEntryN()))[$whereType](group_entry.GroupEntry)[$toList]();
    }
  };
  ...
  dart.setLibraryUri(group$.Group, I[15]);
  ...
  test.Test = class Test extends core.Object {
    filter(callback) {
      if (callback == null) dart.nullFailed(I[16], 41, 36, "callback");
  ...
  dart.setLibraryUri(test.Test, I[17]);
  ...
  suite.Suite = class Suite extends core.Object {
    ...
    static ['_#new#tearOff'](group, platform, opts) {
      if (group == null) dart.nullFailed(I[18], 38, 15, "group");
      if (platform == null) dart.nullFailed(I[18], 38, 27, "platform");
      let ignoreTimeouts = opts && 'ignoreTimeouts' in opts ? opts.ignoreTimeouts : false;
      if (ignoreTimeouts == null) dart.nullFailed(I[18], 38, 43, "ignoreTimeouts");
    ...
    static _filterGroup(group, platform) {
      if (group == null) dart.nullFailed(I[18], 44, 35, "group");
      if (platform == null) dart.nullFailed(I[18], 44, 56, "platform");
    ...
    filter(callback) {
      if (callback == null) dart.nullFailed(I[18], 54, 36, "callback");
  ...
  dart.setLibraryUri(suite.Suite, I[19]);
  ...
  dart.setLibraryUri(live_test.LiveTest, I[20]);
  ...
  state.State = class State extends core.Object {
    ...
    static ['_#new#tearOff'](status, result) {
      if (status == null) dart.nullFailed(I[21], 28, 20, "status");
      if (result == null) dart.nullFailed(I[21], 28, 33, "result");
  ...
  dart.setLibraryUri(state.State, I[22]);
  ...
  state.Status = class Status extends core.Object {
    ...
    static parse(name) {
      if (name == null) dart.nullFailed(I[21], 66, 31, "name");
      switch (name) {
        case "pending":
          {
    ...
    static ['_#_#tearOff'](name) {
      if (name == null) dart.nullFailed(I[21], 79, 23, "name");
  ...
  dart.setLibraryUri(state.Status, I[22]);
  ...
  state.Result = class Result extends core.Object {
    ...
    static parse(name) {
      if (name == null) dart.nullFailed(I[21], 124, 31, "name");
      switch (name) {
        case "success":
          {
    ...
    static ['_#_#tearOff'](name) {
      if (name == null) dart.nullFailed(I[21], 139, 23, "name");
  ...
  dart.setLibraryUri(state.Result, I[22]);
  ...
  message$.Message = class Message extends core.Object {
    ...
    static ['_#new#tearOff'](type, text) {
      if (type == null) dart.nullFailed(I[23], 15, 16, "type");
      if (text == null) dart.nullFailed(I[23], 15, 27, "text");
      return new message$.Message.new(type, text);
    }
    static ['_#print#tearOff'](text) {
      if (text == null) dart.nullFailed(I[23], 17, 22, "text");
      return new message$.Message.print(text);
    }
    static ['_#skip#tearOff'](text) {
      if (text == null) dart.nullFailed(I[23], 18, 21, "text");
  ...
  dart.setLibraryUri(message$.Message, I[24]);
  ...
  message$.MessageType = class MessageType extends core.Object {
    ...
    static parse(name) {
      if (name == null) dart.nullFailed(I[23], 31, 36, "name");
      switch (name) {
        case "print":
          {
    ...
    static ['_#_#tearOff'](name) {
      if (name == null) dart.nullFailed(I[23], 42, 28, "name");
  ...
  dart.setLibraryUri(message$.MessageType, I[24]);
  ...
  dart.setLibraryUri(group_entry.GroupEntry, I[25]);
  ...
  dart.setLibraryUri(test_failure.TestFailure, I[26]);
  ...
  dart.setLibraryUri(closed_exception.ClosedException, I[27]);
  ...
  declarer$.Declarer = class Declarer extends core.Object {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      if (collectTraces == null) dart.nullFailed(I[28], 137, 10, "collectTraces");
      let noRetry = opts && 'noRetry' in opts ? opts.noRetry : false;
      if (noRetry == null) dart.nullFailed(I[28], 138, 10, "noRetry");
      ...
      if (allowDuplicateTestNames == null) dart.nullFailed(I[28], 141, 10, "allowDuplicateTestNames");
    ...
    static ['_#_#tearOff'](_parent, _name, _metadata, _platformVariables, _collectTraces, _trace, _noRetry, _fullTestName, _seenNames) {
      if (_metadata == null) dart.nullFailed(I[28], 156, 10, "_metadata");
      if (_platformVariables == null) dart.nullFailed(I[28], 157, 10, "_platformVariables");
      if (_collectTraces == null) dart.nullFailed(I[28], 158, 10, "_collectTraces");
      if (_noRetry == null) dart.nullFailed(I[28], 160, 10, "_noRetry");
    ...
    declare(T, body) {
      if (body == null) dart.nullFailed(I[28], 168, 29, "body");
      return async.runZoned(T, body, {zoneValues: new (T$.LinkedMapOfObjectN$ObjectN()).from([C[31] || CT.C31, this])});
    }
    test(name, body, opts) {
      if (name == null) dart.nullFailed(I[28], 172, 20, "name");
      if (body == null) dart.nullFailed(I[28], 172, 45, "body");
      let testOn = opts && 'testOn' in opts ? opts.testOn : null;
      let timeout = opts && 'timeout' in opts ? opts.timeout : null;
      let skip = opts && 'skip' in opts ? opts.skip : null;
      let onPlatform = opts && 'onPlatform' in opts ? opts.onPlatform : null;
      ...
      if (solo == null) dart.nullFailed(I[28], 179, 12, "solo");
    ...
    group(name, body, opts) {
      if (name == null) dart.nullFailed(I[28], 228, 21, "name");
      if (body == null) dart.nullFailed(I[28], 228, 43, "body");
      let testOn = opts && 'testOn' in opts ? opts.testOn : null;
      let timeout = opts && 'timeout' in opts ? opts.timeout : null;
      let skip = opts && 'skip' in opts ? opts.skip : null;
      let onPlatform = opts && 'onPlatform' in opts ? opts.onPlatform : null;
      ...
      let retry = opts && 'retry' in opts ? opts.retry : null;
      let solo = opts && 'solo' in opts ? opts.solo : false;
      if (solo == null) dart.nullFailed(I[28], 235, 12, "solo");
    ...
    [_prefix](name) {
      if (name == null) dart.nullFailed(I[28], 279, 25, "name");
      return this[_name$] == null ? name : dart.str(this[_name$]) + " " + dart.str(name);
    }
    setUp(callback) {
      if (callback == null) dart.nullFailed(I[28], 282, 33, "callback");
      this[_checkNotBuilt]("setUp");
      this[_setUps][$add](callback);
    }
    tearDown(callback) {
      if (callback == null) dart.nullFailed(I[28], 288, 36, "callback");
      this[_checkNotBuilt]("tearDown");
      this[_tearDowns][$add](callback);
    }
    setUpAll(callback) {
      if (callback == null) dart.nullFailed(I[28], 294, 36, "callback");
    ...
    tearDownAll(callback) {
      if (callback == null) dart.nullFailed(I[28], 301, 39, "callback");
    ...
    addTearDownAll(callback) {
      if (callback == null) dart.nullFailed(I[28], 309, 42, "callback");
    ...
    build() {
      ...
      let entries = this[_entries][$map](group_entry.GroupEntry, dart.fn(entry => {
        if (entry == null) dart.nullFailed(I[28], 320, 33, "entry");
    ...
    [_checkNotBuilt](name) {
      if (name == null) dart.nullFailed(I[28], 341, 30, "name");
    ...
    [_runSetUps]() {
      return async.async(dart.dynamic, (function* _runSetUps$() {
        ...
        yield async.Future.forEach(core.Function, this[_setUps], dart.fn(setUp => {
          if (setUp == null) dart.nullFailed(I[28], 353, 46, "setUp");
    ...
    get [_setUpAll]() {
      ...
      return new invoker$.LocalTest.new(this[_prefix]("(setUpAll)"), this[_metadata$].change({timeout: this[_timeout]}), dart.fn(() => async.runZoned(async.Future, dart.fn(() => async.Future.forEach(core.Function, this[_setUpAlls], dart.fn(setUp => {
        if (setUp == null) dart.nullFailed(I[28], 363, 55, "setUp");
        return dart.dcall(setUp, []);
      }, T$.FunctionTodynamic())), T$.VoidToFuture()), {zoneValues: new (T$.LinkedMapOfObjectN$ObjectN()).from([C[31] || CT.C31, this])}), T$.VoidToFuture()), {trace: this[_setUpAllTrace], guarded: false, isScaffoldAll: true});
    }
    get [_tearDownAll]() {
    ...
    [_addEntry](entry) {
      let t3;
      if (entry == null) dart.nullFailed(I[28], 385, 29, "entry");
  ...
  (declarer$.Declarer.new = function(opts) {
    ...
    let allowDuplicateTestNames = opts && 'allowDuplicateTestNames' in opts ? opts.allowDuplicateTestNames : true;
    if (allowDuplicateTestNames == null) dart.nullFailed(I[28], 141, 10, "allowDuplicateTestNames");
    declarer$.Declarer.__.call(this, null, null, (t3 = metadata, t3 == null ? metadata$.Metadata.new() : t3), (t3$ = platformVariables, t3$ == null ? C[30] || CT.C30 : t3$), collectTraces, null, noRetry, fullTestName, dart.test(allowDuplicateTestNames) ? null : T$.LinkedHashSetOfString().new());
  ...
  dart.setLibraryUri(declarer$.Declarer, I[29]);
  ...
  dart.setLibraryUri(declarer$.DuplicateTestNameException, I[29]);
  ...
  invoker$.LocalTest = class LocalTest extends test.Test {
    ...
    static ['_#new#tearOff'](name, metadata, _body, opts) {
      if (name == null) dart.nullFailed(I[30], 49, 18, "name");
      if (metadata == null) dart.nullFailed(I[30], 49, 29, "metadata");
      if (_body == null) dart.nullFailed(I[30], 49, 44, "_body");
      let trace = opts && 'trace' in opts ? opts.trace : null;
      let guarded = opts && 'guarded' in opts ? opts.guarded : true;
      if (guarded == null) dart.nullFailed(I[30], 50, 25, "guarded");
      let isScaffoldAll = opts && 'isScaffoldAll' in opts ? opts.isScaffoldAll : false;
      if (isScaffoldAll == null) dart.nullFailed(I[30], 50, 46, "isScaffoldAll");
    ...
    static ['_#_#tearOff'](name, metadata, _body, trace, _guarded, isScaffoldAll) {
      if (name == null) dart.nullFailed(I[30], 53, 20, "name");
      if (metadata == null) dart.nullFailed(I[30], 53, 31, "metadata");
      if (_body == null) dart.nullFailed(I[30], 53, 46, "_body");
      if (_guarded == null) dart.nullFailed(I[30], 53, 70, "_guarded");
      if (isScaffoldAll == null) dart.nullFailed(I[30], 54, 12, "isScaffoldAll");
      return new invoker$.LocalTest.__(name, metadata, _body, trace, _guarded, isScaffoldAll);
    }
    load(suite, opts) {
      if (suite == null) dart.nullFailed(I[30], 58, 23, "suite");
    ...
    forPlatform(platform) {
      if (platform == null) dart.nullFailed(I[30], 64, 35, "platform");
      if (!dart.test(this.metadata.testOn.evaluate(platform))) return null;
  ...
  dart.setLibraryUri(invoker$.LocalTest, I[31]);
  ...
  var __Invoker__controller_isSet = dart.privateName(invoker$, "_#Invoker#_controller#isSet");
  ...
  invoker$.Invoker = class Invoker extends core.Object {
    ...
    get [_controller]() {
      let t3;
      return dart.test(this[__Invoker__controller_isSet]) ? (t3 = this[__Invoker__controller], t3) : dart.throw(new _internal.LateError.fieldNI("_controller"));
    }
    set [_controller](library$32package$58test_api$47src$47backend$47invoker$46dart$58$58_controller$35param) {
      if (library$32package$58test_api$47src$47backend$47invoker$46dart$58$58_controller$35param == null) dart.nullFailed(I[30], 81, 33, "library package:test_api/src/backend/invoker.dart::_controller#param");
      if (dart.test(this[__Invoker__controller_isSet]))
        dart.throw(new _internal.LateError.fieldAI("_controller"));
      else {
        this[__Invoker__controller_isSet] = true;
    ...
    get closed() {
      return !dart.test(this[_forceOpen]) && dart.test(this[_onCloseCompleter].isCompleted);
    }
    get onClose() {
    ...
    static guard(T, callback) {
      if (callback == null) dart.nullFailed(I[30], 153, 35, "callback");
      return async.runZoned(dart.nullable(T), callback, {zoneSpecification: new async._ZoneSpecification.new({handleUncaughtError: dart.fn((self, _, zone, error, stackTrace) => {
            if (self == null) dart.nullFailed(I[30], 158, 33, "self");
            if (_ == null) dart.nullFailed(I[30], 158, 39, "_");
            if (zone == null) dart.nullFailed(I[30], 158, 42, "zone");
            if (error == null) dart.nullFailed(I[30], 158, 48, "error");
            if (stackTrace == null) dart.nullFailed(I[30], 158, 55, "stackTrace");
    ...
    static ['_#_#tearOff'](suite, test, opts) {
      if (suite == null) dart.nullFailed(I[30], 178, 19, "suite");
      if (test == null) dart.nullFailed(I[30], 178, 36, "test");
      let groups = opts && 'groups' in opts ? opts.groups : null;
      let guarded = opts && 'guarded' in opts ? opts.guarded : true;
      if (guarded == null) dart.nullFailed(I[30], 179, 38, "guarded");
      return new invoker$.Invoker.__(suite, test, {groups: groups, guarded: guarded});
    }
    addTearDown(callback) {
      if (callback == null) dart.nullFailed(I[30], 190, 39, "callback");
    ...
    runTearDowns(tearDowns) {
      if (tearDowns == null) dart.nullFailed(I[30], 228, 61, "tearDowns");
      this.heartbeat();
      return async.runZoned(T$.FutureOfvoid(), dart.fn(() => async.async(dart.void, (function*() {
        while (dart.test(tearDowns[$isNotEmpty])) {
    ...
    [_waitForOutstandingCallbacks](fn) {
      if (fn == null) dart.nullFailed(I[30], 249, 71, "fn");
      this.heartbeat();
      let zone = null;
    ...
    heartbeat() {
      ...
      function message() {
        let message = "Test timed out after " + dart.str(pretty_print.niceDuration(timeout)) + ".";
    ...
    printOnFailure(message) {
      if (message == null) dart.nullFailed(I[30], 315, 30, "message");
    ...
    [_handleError](zone, error, stackTrace = null) {
      if (zone == null) dart.nullFailed(I[30], 327, 26, "zone");
      if (error == null) dart.nullFailed(I[30], 327, 39, "error");
      if (!core.identical(this[_runCount], zone._get(C[36] || CT.C36))) return;
    ...
    [_onRun]() {
      ...
      chain.Chain.capture(core.Null, dart.fn(() => {
        this[_guardIfGuarded](dart.fn(() => {
          ...
          }).bind(this)), T$.VoidToFutureOfNull()), {zoneValues: new (T$.LinkedMapOfObjectN$ObjectN()).from([C[32] || CT.C32, this, this[_forceOpenForTearDownKey], false, C[36] || CT.C36, this[_runCount]]), zoneSpecification: new async._ZoneSpecification.new({print: dart.fn((_, __, ___, line) => {
                if (_ == null) dart.nullFailed(I[30], 413, 43, "_");
                if (__ == null) dart.nullFailed(I[30], 413, 46, "__");
                if (___ == null) dart.nullFailed(I[30], 413, 50, "___");
                if (line == null) dart.nullFailed(I[30], 413, 55, "line");
    ...
    [_guardIfGuarded](callback) {
      if (callback == null) dart.nullFailed(I[30], 419, 40, "callback");
    ...
    [_print](text) {
      if (text == null) dart.nullFailed(I[30], 428, 22, "text");
  ...
  (invoker$.Invoker.__ = function(suite, test, opts) {
    ...
    this[__Invoker__controller_isSet] = false;
  ...
  dart.setLibraryUri(invoker$.Invoker, I[31]);
  dart.setFieldSignature(invoker$.Invoker, () => ({
    ...
    [__Invoker__controller_isSet]: dart.fieldType(core.bool),
    [_guarded$]: dart.finalFieldType(core.bool),
  ...
  dart.setLibraryUri(invoker$._AsyncCounter, I[31]);
  ...
  invoker$['_extension#0|get#unawaited'] = function _extension$350$124get$35unawaited(T, $this) {
    if ($this == null) dart.nullFailed(I[30], 460, 12, "#this");
  };
  ...
  live_test_controller.LiveTestController = class LiveTestController extends live_test.LiveTest {
    ...
    static ['_#new#tearOff'](suite, test, _onRun, _onClose, opts) {
      if (suite == null) dart.nullFailed(I[32], 101, 27, "suite");
      if (test == null) dart.nullFailed(I[32], 101, 39, "test");
      if (_onRun == null) dart.nullFailed(I[32], 101, 50, "_onRun");
      if (_onClose == null) dart.nullFailed(I[32], 101, 63, "_onClose");
      let groups = opts && 'groups' in opts ? opts.groups : null;
      return new live_test_controller.LiveTestController.new(suite, test, _onRun, _onClose, {groups: groups});
    }
    addError(error, stackTrace) {
      let t4;
      if (error == null) dart.nullFailed(I[32], 110, 24, "error");
    ...
    setState(newState) {
      if (newState == null) dart.nullFailed(I[32], 124, 23, "newState");
      if (dart.test(this[_isClosed])) return;
    ...
    message(message) {
      if (message == null) dart.nullFailed(I[32], 133, 24, "message");
      if (dart.test(this[_onMessage].hasListener)) {
  ...
  dart.setLibraryUri(live_test_controller.LiveTestController, I[33]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["metadata.dart","util/pretty_print.dart","util/identifier_regex.dart","suite_platform.dart","runtime.dart","operating_system.dart","platform_selector.dart","configuration/timeout.dart","configuration/skip.dart","group.dart","test.dart","suite.dart","live_test.dart","state.dart","message.dart","group_entry.dart","test_failure.dart","closed_exception.dart","declarer.dart","invoker.dart","live_test_controller.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA0ByB;;;;;;IAGT;;;;;;IAOA;;;;;;IAWI;;;;;;IAUoB;;;;;;IAUD;;;;;;IAKvB;;;;;;;;AAxCG;0BAAS;IAAK;;;AAON;0BAAiB;IAAK;;;AAIlB,aAAkB,8BAAlB,aAAqB;YAAH,eAAoB;IAAK;;;AAOvD;0BAAU;IAAC;4BA0BF;AACxB,UAAI,AAAW,UAAD,UAAU,MAAO;AAE3B,mBAAqC;AAWvC,MAVF,AAAW,UAAD,WAAS,SAAC,UAAU;;AACxB,uBAA4B,6CAAM,QAAQ;AAC9C,