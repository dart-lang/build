define(['dart_sdk', 'packages/test_api/src/backend/closed_exception', 'packages/stack_trace/src/chain'], (function load__packages__test_api__src__backend__remote_exception(dart_sdk, packages__test_api__src__backend__closed_exception, packages__stack_trace__src__chain) {
  ...
  var I = ["package:test_api/src/backend/remote_exception.dart"];
  ...
  remote_exception.RemoteException = class RemoteException extends core.Object {
    ...
    static serialize(error, stackTrace) {
      ...
      return new (T.IdentityMapOfString$dynamic()).from(["message", message, "type", dart.runtimeType(error).toString(), "supertype", supertype, "toString", dart.toString(error), "stackChain", chain.Chain.forTrace(stackTrace).toString()]);
    }
  ...
  dart.setLibraryUri(remote_exception.RemoteException, I[0]);
  ...
  dart.setLibraryUri(remote_exception._RemoteTestFailure, I[0]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["remote_exception.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;IAmBgB;;;;;;IAGD;;;;;;qBASyB,OAAkB;AAC9C;AACR,UAAU,OAAN,KAAK;AACQ,QAAf,UAAU,KAAK;;AAEf;AACoC,UAAlC,UAAwB,cAAR,WAAN,KAAK;;cACa;AAA5B;;;;;AAKE,sBAAmB,4BAAN,KAAK,IAAmB,gBAAgB;AAE3D,YAAO,6CACL,WAAW,OAAO,EAClB,QAAc,AAAY,iBAAlB,KAAK,cACb,aAAa,SAAS,EACtB,YAAkB,cAAN,KAAK,GACjB,cAAoB,AAAqB,qBAAZ,UAAU;IAE3C;uBAM8B;AAC5B,YAAO,0BAAW,uDAAsB,UAAU,GACxC,kBAA+B,eAAf,WAAV,UAAU,WAAC;IAC7B;iCAG6C;AACrC,oBAAgC,eAAZ,WAAV,UAAU,WAAC;AACrB,iBAA0B,eAAT,WAAV,UAAU,WAAC;AAClB,qBAAkC,eAAb,WAAV,UAAU,WAAC;AAE5B,cAAgC,eAAd,WAAV,UAAU,WAAC;;;AAEf,kBAAO,6CAAmB,OAAO,EAAE,IAAI,EAAE,QAAQ;;;;AAEjD,kBAAuB,yCAAE,OAAO,EAAE,IAAI,EAAE,QAAQ;;;IAEtD;;;;;AAKqB;IAAS;;kDAHP,SAAc,MAAW;IAAzB;IAAc;IAAW;;EAAU;;;;;;;;;;;;;;;;;;sDAW/B,SAAgB,MAAa;AAC5C,gEAAE,OAAO,EAAE,IAAI,EAAE,QAAQ;;EAAC","file":"remote_exception.sound.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=remote_exception.sound.ddc.js.map
