define(['dart_sdk', 'packages/test_core/src/runner/plugin/remote_platform_helpers', 'packages/test_core/src/util/stack_trace_mapper', 'packages/stream_channel/stream_channel'], (function load__packages__test__bootstrap__browser(dart_sdk, packages__test_core__src__runner__plugin__remote_platform_helpers, packages__test_core__src__util__stack_trace_mapper, packages__stream_channel__stream_channel) {
  ...
  browser.internalBootstrapBrowserTest = function internalBootstrapBrowserTest(getMain, opts) {
    ...
    let channel = remote_platform_helpers.serializeSuite(getMain, {hidePrints: false, beforeLoad: dart.fn(suiteChannel => async.async(core.Null, function*() {
  ...
  post_message_channel.postMessageChannel = function postMessageChannel() {
    ...
    html.window[$onMessage].firstWhere(dart.fn(message => message[$origin] === html.window[$location][$origin] && dart.equals(message[$data], "port"), T.MessageEventTobool())).then(core.Null, dart.fn(message => {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["../src/bootstrap/browser.dart","../src/runner/browser/post_message_channel.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;+EAWsD;;QACzB;AACvB,kBAAU,uCAAe,OAAO,eAAc,mBAClC,QAAC;AACX,0BAAa,MAAM,AAAY,AAAwB,AAAO,YAA/B,CAAC;AACpC,aAAe,YAAX,UAAU,GAAU;AACwC,QAAhE,4CAA8D,eAAvB,kDAAY,UAAU;MAC9D;AACkD,IAAb,CAAzB,KAAZ,WAAW,EAAX,aAAe,qDAA2B,OAAO;EACpD;;ACAM,qBAAa,sDAAuC;AAwBtD,IAlBF,AAAO,AAAU,AAMd,mCANyB,QAAC,WAKpB,AAAQ,AAAO,AAA0B,OAAlC,cAAW,AAAO,AAAS,mCAAuB,YAAb,AAAQ,OAAD,SAAS,kDAC7D,QAAC;AACH,iBAAO,AAAQ,AAAM,OAAP;AACd,6BAAmB,AAAK,AAAU,IAAX,oBAAkB,QAAC;AACL,QAAvC,AAAW,AAAM,AAAK,UAAZ,gBAAgB,AAAQ,OAAD;;AAQjC,MALF,AAAW,AAAM,AAAO,UAAd,qBAAqB,QAAC;AACE,QAAhC,AAAK,IAAD,eAAa,4CAAC,QAAQ,IAAI;sCACrB;AAC0B,UAAnC,AAAK,IAAD,eAAa,2CAAC,SAAS;AACF,UAAzB,AAAiB,gBAAD;;;AASO,IAF3B,sCACyD,eAArD,cAAM,2CAAC,QAAQ,AAAO,AAAS,+BAAM,SAAS,UAC9C,AAAO,AAAS;AAEpB,UAAO,AAAW,WAAD;EACnB","file":"browser.sound.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=browser.sound.ddc.js.map
