define(['dart_sdk', 'packages/source_maps/printer', 'packages/source_span/source_span'], (function load__packages__source_maps__refactor(dart_sdk, packages__source_maps__printer, packages__source_span__source_span) {
  ...
  var I = [
    "org-dartlang-app:///packages/source_maps/refactor.dart",
    "package:source_maps/refactor.dart"
  ];
  ...
  refactor.TextEditTransaction = class TextEditTransaction extends core.Object {
    ...
    static ['_#new#tearOff'](original, file) {
      if (original == null) dart.nullFailed(I[0], 25, 28, "original");
    ...
    edit(begin, end, replacement) {
      if (begin == null) dart.nullFailed(I[0], 32, 17, "begin");
      if (end == null) dart.nullFailed(I[0], 32, 28, "end");
      this[_edits][$add](new refactor._TextEdit.new(begin, end, replacement));
    }
    [_loc](offset) {
      let t0;
      if (offset == null) dart.nullFailed(I[0], 38, 28, "offset");
      t0 = this.file;
    ...
    commit() {
      ...
      if (dart.test(this[_edits][$isEmpty])) {
        t0 = printer;
        return (() => {
  ...
  dart.setLibraryUri(refactor.TextEditTransaction, I[1]);
  ...
  refactor._TextEdit = class _TextEdit extends core.Object {
    static ['_#new#tearOff'](begin, end, replace) {
      if (begin == null) dart.nullFailed(I[0], 96, 18, "begin");
      if (end == null) dart.nullFailed(I[0], 96, 30, "end");
    ...
    compareTo(other) {
      ...
      if (other == null) dart.nullFailed(I[0], 104, 27, "other");
  ...
  dart.setLibraryUri(refactor._TextEdit, I[1]);
  ...
  refactor.guessIndent = function guessIndent(code, charOffset) {
    if (code == null) dart.nullFailed(I[0], 112, 27, "code");
    if (charOffset == null) dart.nullFailed(I[0], 112, 37, "charOffset");
    let lineStart = 0;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["refactor.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAmBoB;;;;;;IACL;;;;;;;;;;;AAMQ,YAAA,AAAO;IAAU;SAKxB,OAAW,KAAK;;;AACkB,MAA9C,AAAO,mBAAI,2BAAU,KAAK,EAAE,GAAG,EAAE,WAAW;IAC9C;WAIyB;;;AAAW;iCAAM,YAAS,MAAM;IAAC;;;AAUpD,oBAAU;AACd,oBAAI,AAAO;AACT,aAAO,OAAO;cAAP;AAAS,iBAAI,0BAAoB,WAAK,gBAAgB;;;;AAIlD,MAAb,AAAO;AAEH,qBAAW;AACf,eAAS,OAAQ;AACf,YAAa,aAAT,QAAQ,iBAAG,AAAK,IAAD;AACb,mBAAK;AAOqC,gBAN9C,EAAE;UAAF;AACI,oDAAM,OAAM,AAAqB,YAAZ,AAAK,IAAD;AACzB,sBAAM;AACN,sBAAM,AAAK,IAAD;AACV,sBAAM;AACN,sBAAM,QAAQ;AACd,sBAAM;;;AACV,mBAAS,IAAK;AACiB,mBAA7B,EAAE;YAAF;AAAI,yBAAM;AAAW,yBAAM,CAAC;;;;AAEO,UAArC,WAAM,8BAAiB,AAAG,EAAD;;AAKvB,2BAAe,AAAS,0BAAU,QAAQ,EAAE,AAAK,IAAD;AAGH,eAFjD,OAAO;QAAP;AACI,mBAAI,YAAY,aAAY,WAAK,QAAQ,eAAe;AACxD,mBAAI,AAAK,IAAD,qBAAoB,WAAK,AAAK,IAAD;;;AACtB,QAAnB,WAAW,AAAK,IAAD;;AAK8B,MAD/C,AAAQ,OAAD,KAAK,AAAS,0BAAU,QAAQ,cACzB,WAAK,QAAQ,eAAe;AAC1C,YAAO,QAAO;IAChB;;+CA7DyB,UAAe;;IAHlC,eAAoB;IAGD;IAAe;;EAAK;;;;;;;;;;;;;;;;;;;;;;;;;;;AAyE3B,YAAI,cAAJ,yBAAM;IAAK;;AAGR,YAAA,AAAkC,uBAAxB,cAAK,eAAE,YAAG,kBAAI,gBAAO;IAAG;cAG/B;;;AAClB,iBAAa,aAAN,2BAAQ,AAAM,KAAD;AACxB,UAAI,IAAI,KAAI,GAAG,MAAO,KAAI;AAC1B,YAAW,cAAJ,yBAAM,AAAM,KAAD;IACpB;;qCAZe,OAAY,KAAU;;;IAAtB;IAAY;IAAU;;EAAQ;;;;;;;;;;;;;;;;;;;;;8CAgBrB,MAAU;;;AAE9B,oBAAY;AAChB,aAAS,IAAe,aAAX,UAAU,IAAG,GAAG,AAAE,CAAD,IAAI,GAAG,IAAA,AAAC,CAAA;AAChC,cAAI,AAAK,IAAD,cAAY,CAAC;AACzB,UAAI,AAAE,CAAD,WAAW,AAAE,CAAD;AACE,QAAjB,YAAY,AAAE,CAAD,GAAG;AAChB;;;AAKA,wBAAgB,AAAK,IAAD;AACxB,aAAS,IAAI,SAAS,EAAE,AAAE,CAAD,GAAG,AAAK,IAAD,SAAS,IAAA,AAAC,CAAA;AACpC,cAAI,AAAK,IAAD,cAAY,CAAC;AACzB,UAAI,CAAC,WAAc,CAAC;AACD,QAAjB,gBAAgB,CAAC;AACjB;;;AAIJ,UAAO,AAAK,KAAD,aAAW,SAAS,EAAE,aAAa;EAChD;;MAEU,YAAG;;;MACH,YAAG;;;MACH,aAAI;;;MACJ,eAAM","file":"refactor.unsound.ddc.js"}');
  // Exports:
  return {
    refactor: refactor
  };
...
//# sourceMappingURL=refactor.unsound.ddc.js.map
