define(['dart_sdk', 'packages/path/path'], (function load__packages__stack_trace__src__chain(dart_sdk, packages__path__path) {
  ...
  var I = [
    "org-dartlang-app:///packages/stack_trace/src/trace.dart",
    "package:stack_trace/src/trace.dart",
    "org-dartlang-app:///packages/stack_trace/src/vm_trace.dart",
    "package:stack_trace/src/vm_trace.dart",
    "org-dartlang-app:///packages/stack_trace/src/frame.dart",
    "package:stack_trace/src/frame.dart",
    "org-dartlang-app:///packages/stack_trace/src/unparsed_frame.dart",
    "package:stack_trace/src/unparsed_frame.dart",
    "org-dartlang-app:///packages/stack_trace/src/lazy_trace.dart",
    "package:stack_trace/src/lazy_trace.dart",
    "org-dartlang-app:///packages/stack_trace/src/chain.dart",
    "package:stack_trace/src/chain.dart",
    "org-dartlang-app:///packages/stack_trace/src/stack_zone_specification.dart",
    "package:stack_trace/src/stack_zone_specification.dart",
    "org-dartlang-app:///packages/stack_trace/src/lazy_chain.dart",
  ...
  trace$.Trace = class Trace extends core.Object {
    ...
    static format(stackTrace, opts) {
      if (stackTrace == null) dart.nullFailed(I[0], 79, 35, "stackTrace");
      let terse = opts && 'terse' in opts ? opts.terse : true;
      if (terse == null) dart.nullFailed(I[0], 79, 53, "terse");
    ...
    static current(level = 0) {
      if (level == null) dart.nullFailed(I[0], 90, 30, "level");
      ...
      return new lazy_trace.LazyTrace.new(dart.fn(() => new trace$.Trace.new(trace.frames[$skip](dart.notNull(level) + (dart.test(utils.inJS) ? 2 : 1)), {original: dart.toString(trace.original)}), T$.VoidToTrace()));
    }
    ...
    static from(trace) {
      if (trace == null) dart.nullFailed(I[0], 109, 33, "trace");
    ...
    static parse(trace) {
      if (trace == null) dart.nullFailed(I[0], 120, 30, "trace");
      try {
    ...
    static ['_#parseVM#tearOff'](trace) {
      if (trace == null) dart.nullFailed(I[0], 144, 24, "trace");
      return new trace$.Trace.parseVM(trace);
    }
    static _parseVM(trace) {
      if (trace == null) dart.nullFailed(I[0], 146, 38, "trace");
      let lines = trace[$trim]()[$replaceAll](utils.vmChainGap, "")[$split]("\n")[$where](dart.fn(line => {
        if (line == null) dart.nullFailed(I[0], 153, 17, "line");
        return line[$isNotEmpty];
      }, T$.StringTobool()));
      if (dart.test(lines[$isEmpty])) {
        return T$.JSArrayOfFrame().of([]);
      }
      let frames = lines[$take](dart.notNull(lines[$length]) - 1)[$map](frame$.Frame, dart.fn(line => {
        if (line == null) dart.nullFailed(I[0], 161, 15, "line");
        return frame$.Frame.parseVM(line);
      }, T$.StringToFrame()))[$toList]();
    ...
    get terse() {
      return this.foldFrames(dart.fn(_ => {
        if (_ == null) dart.nullFailed(I[0], 272, 34, "_");
        return false;
      }, T$.FrameTobool()), {terse: true});
    }
    foldFrames(predicate, opts) {
      if (predicate == null) dart.nullFailed(I[0], 285, 41, "predicate");
      let terse = opts && 'terse' in opts ? opts.terse : false;
      if (terse == null) dart.nullFailed(I[0], 285, 58, "terse");
      if (dart.test(terse)) {
        let oldPredicate = predicate;
        predicate = dart.fn(frame => {
          if (frame == null) dart.nullFailed(I[0], 288, 20, "frame");
      ...
      if (dart.test(terse)) {
        newFrames = newFrames[$map](frame$.Frame, dart.fn(frame => {
          if (frame == null) dart.nullFailed(I[0], 316, 34, "frame");
    ...
    toString() {
      let longest = this.frames[$map](core.int, dart.fn(frame => {
        if (frame == null) dart.nullFailed(I[0], 334, 21, "frame");
        return frame.location.length;
      }, T$.FrameToint()))[$fold](core.int, 0, C[0] || CT.C0);
      return this.frames[$map](core.String, dart.fn(frame => {
        if (frame == null) dart.nullFailed(I[0], 337, 24, "frame");
  ...
  (trace$.Trace.parseV8 = function(trace) {
    if (trace == null) dart.nullFailed(I[0], 173, 24, "trace");
    trace$.Trace.new.call(this, trace[$split]("\n")[$skip](1)[$skipWhile](dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 181, 29, "line");
      return !line[$startsWith](trace$._v8TraceLine);
    }, T$.StringTobool()))[$map](frame$.Frame, dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 182, 23, "line");
      return frame$.Frame.parseV8(line);
    }, T$.StringToFrame())), {original: trace});
  }).prototype = trace$.Trace.prototype;
  (trace$.Trace.parseJSCore = function(trace) {
    if (trace == null) dart.nullFailed(I[0], 186, 28, "trace");
    trace$.Trace.new.call(this, trace[$split]("\n")[$where](dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 190, 25, "line");
      return line !== "\tat ";
    }, T$.StringTobool()))[$map](frame$.Frame, dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 191, 23, "line");
      return frame$.Frame.parseV8(line);
    }, T$.StringToFrame())), {original: trace});
  }).prototype = trace$.Trace.prototype;
  ...
  (trace$.Trace.parseFirefox = function(trace) {
    ...
    trace$.Trace.new.call(this, trace[$trim]()[$split]("\n")[$where](dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 206, 25, "line");
      return line[$isNotEmpty] && line !== "[native code]";
    }, T$.StringTobool()))[$map](frame$.Frame, dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 207, 23, "line");
      return frame$.Frame.parseFirefox(line);
    }, T$.StringToFrame())), {original: trace});
  }).prototype = trace$.Trace.prototype;
  ...
  (trace$.Trace.parseSafari6_0 = function(trace) {
    if (trace == null) dart.nullFailed(I[0], 219, 31, "trace");
    trace$.Trace.new.call(this, trace[$trim]()[$split]("\n")[$where](dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 224, 25, "line");
      return line !== "[native code]";
    }, T$.StringTobool()))[$map](frame$.Frame, dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 225, 23, "line");
      return frame$.Frame.parseFirefox(line);
    }, T$.StringToFrame())), {original: trace});
  }).prototype = trace$.Trace.prototype;
  (trace$.Trace.parseFriendly = function(trace) {
    ...
    trace$.Trace.new.call(this, trace[$isEmpty] ? T$.JSArrayOfFrame().of([]) : trace[$trim]()[$split]("\n")[$where](dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 240, 29, "line");
      return !line[$startsWith]("=====");
    }, T$.StringTobool()))[$map](frame$.Frame, dart.fn(line => {
      if (line == null) dart.nullFailed(I[0], 241, 27, "line");
      return frame$.Frame.parseFriendly(line);
    }, T$.StringToFrame())), {original: trace});
  }).prototype = trace$.Trace.prototype;
  ...
  dart.setLibraryUri(trace$.Trace, I[1]);
  ...
  vm_trace.VMTrace = class VMTrace extends core.Object {
    ...
    static ['_#new#tearOff'](frames) {
      if (frames == null) dart.nullFailed(I[2], 16, 16, "frames");
    ...
    toString() {
      ...
      return this.frames[$map](core.String, dart.fn(frame => {
        let t1, t1$, t1$0;
        if (frame == null) dart.nullFailed(I[2], 21, 24, "frame");
        let number = ("#" + dart.str((t1 = i, i = t1 + 1, t1)))[$padRight](8);
        let member = dart.nullCheck(frame.member)[$replaceAllMapped](core.RegExp.new("[^.]+\\.<async>"), dart.fn(match => {
          if (match == null) dart.nullFailed(I[2], 25, 16, "match");
          return dart.str(match._get(1)) + ".<" + dart.str(match._get(1)) + "_async_body>";
        }, T$.MatchToString()))[$replaceAll]("<fn>", "<anonymous closure>");
  ...
  dart.setLibraryUri(vm_trace.VMTrace, I[3]);
  ...
  frame$.Frame = class Frame extends core.Object {
    ...
    static caller(level = 1) {
      if (level == null) dart.nullFailed(I[4], 127, 29, "level");
      if (dart.notNull(level) < 0) {
        dart.throw(new core.ArgumentError.new("Argument [level] must be greater than or equal " + "to 0."));
      }
    ...
    static parseVM(frame) {
      if (frame == null) dart.nullFailed(I[4], 137, 32, "frame");
    ...
    static parseV8(frame) {
      if (frame == null) dart.nullFailed(I[4], 165, 32, "frame");
      return frame$.Frame._catchFormatException(frame, dart.fn(() => {
        let match = frame$._v8Frame.firstMatch(frame);
        if (match == null) return new unparsed_frame.UnparsedFrame.new(frame);
        function parseLocation(location, member) {
          if (location == null) dart.nullFailed(I[4], 171, 36, "location");
          if (member == null) dart.nullFailed(I[4], 171, 53, "member");
    ...
    static parseJSCore(frame) {
      if (frame == null) dart.nullFailed(I[4], 211, 36, "frame");
      return frame$.Frame.parseV8(frame);
    }
    ...
    static parseIE(frame) {
      if (frame == null) dart.nullFailed(I[4], 217, 32, "frame");
      return frame$.Frame.parseV8(frame);
    }
    ...
    static _parseFirefoxEval(frame) {
      if (frame == null) dart.nullFailed(I[4], 224, 42, "frame");
      return frame$.Frame._catchFormatException(frame, dart.fn(() => {
    ...
    static parseFirefox(frame) {
      if (frame == null) dart.nullFailed(I[4], 238, 37, "frame");
      return frame$.Frame._catchFormatException(frame, dart.fn(() => {
        ...
        if (member != null) {
          member = dart.notNull(member) + dart.notNull(T$.ListOfString().filled("/"[$allMatches](dart.nullCheck(match._get(2)))[$length], ".<fn>")[$join]());
          if (member === "") member = "<fn>";
    ...
    static parseSafari6_0(frame) {
      if (frame == null) dart.nullFailed(I[4], 270, 39, "frame");
      return frame$.Frame.parseFirefox(frame);
    }
    ...
    static parseSafari6_1(frame) {
      if (frame == null) dart.nullFailed(I[4], 274, 39, "frame");
      return frame$.Frame.parseFirefox(frame);
    }
    ...
    static parseSafari(frame) {
      if (frame == null) dart.nullFailed(I[4], 277, 36, "frame");
      return frame$.Frame.parseFirefox(frame);
    }
    ...
    static parseFriendly(frame) {
      if (frame == null) dart.nullFailed(I[4], 280, 38, "frame");
      return frame$.Frame._catchFormatException(frame, dart.fn(() => {
    ...
    static _uriOrPathToUri(uriOrPath) {
      if (uriOrPath == null) dart.nullFailed(I[4], 311, 37, "uriOrPath");
    ...
    static _catchFormatException(text, body) {
      if (text == null) dart.nullFailed(I[4], 331, 45, "text");
      if (body == null) dart.nullFailed(I[4], 331, 68, "body");
      try {
        return body();
      } catch (e) {
    ...
    static ['_#new#tearOff'](uri, line, column, member) {
      if (uri == null) dart.nullFailed(I[4], 339, 14, "uri");
      return new frame$.Frame.new(uri, line, column, member);
    }
    toString() {
  ...
  dart.setLibraryUri(frame$.Frame, I[5]);
  ...
  unparsed_frame.UnparsedFrame = class UnparsedFrame extends core.Object {
    ...
    static ['_#new#tearOff'](member) {
      if (member == null) dart.nullFailed(I[6], 29, 22, "member");
  ...
  dart.setLibraryUri(unparsed_frame.UnparsedFrame, I[7]);
  ...
  var __LazyTrace__trace_isSet = dart.privateName(lazy_trace, "_#LazyTrace#_trace#isSet");
  ...
  lazy_trace.LazyTrace = class LazyTrace extends core.Object {
    get [_trace]() {
      let t3;
      if (!dart.test(this[__LazyTrace__trace_isSet])) {
        let t2 = this[_thunk$]();
        if (dart.test(this[__LazyTrace__trace_isSet])) dart.throw(new _internal.LateError.fieldADI("_trace"));
        this[__LazyTrace__trace] = t2;
        this[__LazyTrace__trace_isSet] = true;
      }
      t3 = this[__LazyTrace__trace];
      return t3;
    }
    static ['_#new#tearOff'](_thunk) {
      if (_thunk == null) dart.nullFailed(I[8], 18, 18, "_thunk");
    ...
    foldFrames(predicate, opts) {
      if (predicate == null) dart.nullFailed(I[8], 29, 41, "predicate");
      let terse = opts && 'terse' in opts ? opts.terse : false;
      if (terse == null) dart.nullFailed(I[8], 29, 58, "terse");
  ...
  (lazy_trace.LazyTrace.new = function(_thunk) {
    ...
    this[__LazyTrace__trace_isSet] = false;
    this[_thunk$] = _thunk;
    ;
  ...
  dart.setLibraryUri(lazy_trace.LazyTrace, I[9]);
  dart.setFieldSignature(lazy_trace.LazyTrace, () => ({
    ...
    [__LazyTrace__trace_isSet]: dart.fieldType(core.bool)
  }));
  ...
  chain$.Chain = class Chain extends core.Object {
    ...
    static capture(T, callback, opts) {
      if (callback == null) dart.nullFailed(I[10], 75, 36, "callback");
      let onError = opts && 'onError' in opts ? opts.onError : null;
      let when = opts && 'when' in opts ? opts.when : true;
      if (when == null) dart.nullFailed(I[10], 77, 12, "when");
      let errorZone = opts && 'errorZone' in opts ? opts.errorZone : true;
      if (errorZone == null) dart.nullFailed(I[10], 78, 12, "errorZone");
      ...
      if (!dart.test(when)) {
        ...
        return T.as(async.runZonedGuarded(T, callback, dart.fn((error, stackTrace) => {
          if (error == null) dart.nullFailed(I[10], 86, 41, "error");
          if (stackTrace == null) dart.nullFailed(I[10], 86, 48, "stackTrace");
    ...
    static disable(T, callback, opts) {
      if (callback == null) dart.nullFailed(I[10], 114, 36, "callback");
      let when = opts && 'when' in opts ? opts.when : true;
      if (when == null) dart.nullFailed(I[10], 114, 52, "when");
      let zoneValues = dart.test(when) ? new (T$.LinkedMapOfObject$boolN()).from([chain$._specKey, null, stack_zone_specification.StackZoneSpecification.disableKey, true]) : null;
    ...
    static current(level = 0) {
      if (level == null) dart.nullFailed(I[10], 137, 30, "level");
      if (chain$.Chain._currentSpec != null) return dart.nullCheck(chain$.Chain._currentSpec).currentChain(dart.notNull(level) + 1);
      ...
      return new lazy_chain.LazyChain.new(dart.fn(() => {
        ...
        return new chain$.Chain.new((() => {
          let t4 = T$.JSArrayOfTrace().of([first]);
          t4[$addAll](chain.traces[$skip](1));
          return t4;
        })());
      }, T$.VoidToChain()));
    }
    ...
    static forTrace(trace) {
      if (trace == null) dart.nullFailed(I[10], 158, 37, "trace");
    ...
    static parse(chain) {
      if (chain == null) dart.nullFailed(I[10], 170, 30, "chain");
      if (chain[$isEmpty]) return new chain$.Chain.new(T$.JSArrayOfTrace().of([]));
      if (chain[$contains](utils.vmChainGap)) {
        return new chain$.Chain.new(chain[$split](utils.vmChainGap)[$where](dart.fn(line => {
          if (line == null) dart.nullFailed(I[10], 175, 19, "line");
          return line[$isNotEmpty];
        }, T$.StringTobool()))[$map](trace$.Trace, dart.fn(trace => {
          if (trace == null) dart.nullFailed(I[10], 176, 17, "trace");
          return new trace$.Trace.parseVM(trace);
        }, T$.StringToTrace())));
      }
      if (!chain[$contains](utils.chainGap)) return new chain$.Chain.new(T$.JSArrayOfTrace().of([trace$.Trace.parse(chain)]));
      return new chain$.Chain.new(chain[$split](utils.chainGap)[$map](trace$.Trace, dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 181, 36, "trace");
        return new trace$.Trace.parseFriendly(trace);
      }, T$.StringToTrace())));
    }
    ...
    static ['_#new#tearOff'](traces) {
      if (traces == null) dart.nullFailed(I[10], 185, 25, "traces");
      return new chain$.Chain.new(traces);
    }
    get terse() {
      return this.foldFrames(dart.fn(_ => {
        if (_ == null) dart.nullFailed(I[10], 198, 34, "_");
        return false;
      }, T$.FrameTobool()), {terse: true});
    }
    foldFrames(predicate, opts) {
      if (predicate == null) dart.nullFailed(I[10], 213, 41, "predicate");
      let terse = opts && 'terse' in opts ? opts.terse : false;
      if (terse == null) dart.nullFailed(I[10], 213, 58, "terse");
      let foldedTraces = this.traces[$map](trace$.Trace, dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 215, 21, "trace");
        return trace.foldFrames(predicate, {terse: terse});
      }, T$.TraceToTrace()));
      let nonEmptyTraces = foldedTraces[$where](dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 216, 46, "trace");
    ...
    toTrace() {
      return new trace$.Trace.new(this.traces[$expand](frame$.Frame, dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 241, 43, "trace");
        return trace.frames;
      }, T$.TraceToListOfFrame())));
    }
    toString() {
      let longest = this.traces[$map](core.int, dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 246, 31, "trace");
        return trace.frames[$map](core.int, dart.fn(frame => {
          if (frame == null) dart.nullFailed(I[10], 248, 17, "frame");
          return frame.location.length;
        }, T$.FrameToint()))[$fold](core.int, 0, C[0] || CT.C0);
      }, T$.TraceToint()))[$fold](core.int, 0, C[0] || CT.C0);
      return this.traces[$map](core.String, dart.fn(trace => {
        if (trace == null) dart.nullFailed(I[10], 254, 24, "trace");
        return trace.frames[$map](core.String, dart.fn(frame => {
          if (frame == null) dart.nullFailed(I[10], 255, 32, "frame");
          return frame.location[$padRight](longest) + "  " + dart.str(frame.member) + "\n";
        }, T$.FrameToString()))[$join]();
      }, T$.TraceToString()))[$join](utils.chainGap);
    }
  };
  ...
  dart.setLibraryUri(chain$.Chain, I[11]);
  ...
  stack_zone_specification.StackZoneSpecification = class StackZoneSpecification extends core.Object {
    ...
    static ['_#new#tearOff'](_onError, opts) {
      let errorZone = opts && 'errorZone' in opts ? opts.errorZone : true;
      if (errorZone == null) dart.nullFailed(I[12], 64, 47, "errorZone");
    ...
    currentChain(level = 0) {
      if (level == null) dart.nullFailed(I[12], 82, 27, "level");
    ...
    chainFor(trace) {
      ...
      let previous = (t5 = this[_chains]._get(trace), t5 == null ? this[_currentNode] : t5);
      if (previous == null) {
        if (trace$.Trace.is(trace)) return new chain$.Chain.new(T$.JSArrayOfTrace().of([trace]));
    ...
    [_registerCallback](R, self, parent, zone, f) {
      if (self == null) dart.nullFailed(I[12], 113, 12, "self");
      if (parent == null) dart.nullFailed(I[12], 113, 31, "parent");
      if (zone == null) dart.nullFailed(I[12], 113, 44, "zone");
      if (f == null) dart.nullFailed(I[12], 113, 63, "f");
      if (dart.test(this[_disabled])) return parent.registerCallback(R, zone, f);
    ...
    [_registerUnaryCallback](R, T, self, parent, zone, f) {
      if (self == null) dart.nullFailed(I[12], 122, 12, "self");
      if (parent == null) dart.nullFailed(I[12], 122, 31, "parent");
      if (zone == null) dart.nullFailed(I[12], 122, 44, "zone");
      if (f == null) dart.nullFailed(I[12], 122, 64, "f");
      if (dart.test(this[_disabled])) return parent.registerUnaryCallback(R, T, zone, f);
      let node = this[_createNode](1);
    ...
    [_registerBinaryCallback](R, T1, T2, self, parent, zone, f) {
      if (self == null) dart.nullFailed(I[12], 133, 12, "self");
      if (parent == null) dart.nullFailed(I[12], 133, 31, "parent");
      if (zone == null) dart.nullFailed(I[12], 133, 44, "zone");
      if (f == null) dart.nullFailed(I[12], 133, 69, "f");
      if (dart.test(this[_disabled])) return parent.registerBinaryCallback(R, T1, T2, zone, f);
      let node = this[_createNode](1);
    ...
    [_handleUncaughtError](self, parent, zone, error, stackTrace) {
      if (self == null) dart.nullFailed(I[12], 144, 34, "self");
      if (parent == null) dart.nullFailed(I[12], 144, 53, "parent");
      if (zone == null) dart.nullFailed(I[12], 144, 66, "zone");
      if (error == null) dart.nullFailed(I[12], 145, 14, "error");
      if (stackTrace == null) dart.nullFailed(I[12], 145, 32, "stackTrace");
    ...
    [_errorCallback](self, parent, zone, error, stackTrace) {
      let t6;
      if (self == null) dart.nullFailed(I[12], 174, 35, "self");
      if (parent == null) dart.nullFailed(I[12], 174, 54, "parent");
      if (zone == null) dart.nullFailed(I[12], 174, 67, "zone");
      if (error == null) dart.nullFailed(I[12], 175, 14, "error");
      ...
      t6 = asyncError;
      return t6 == null ? new async.AsyncError.new(error, stackTrace) : t6;
    }
    [_createNode](level = 0) {
      if (level == null) dart.nullFailed(I[12], 195, 26, "level");
      return new stack_zone_specification._Node.new(this[_currentTrace](dart.notNull(level) + 1), this[_currentNode]);
    }
    [_run](T, f, node) {
      let t7;
      if (f == null) dart.nullFailed(I[12], 204, 26, "f");
      if (node == null) dart.nullFailed(I[12], 204, 35, "node");
      ...
      try {
        ...
        if (core.Object.is(e)) {
          t7 = this[_chains];
          t7._get(stackTrace) == null ? t7._set(stackTrace, node) : null;
          dart.rethrow(e$);
        } else
          throw e$;
      } finally {
    ...
    [_currentTrace](level = null) {
      ...
      return new lazy_trace.LazyTrace.new(dart.fn(() => {
        ...
        return new trace$.Trace.new(trace.frames[$skip](dart.notNull((t7 = level, t7 == null ? 0 : t7)) + (dart.test(utils.inJS) ? 2 : 1)), {original: text});
      }, T$.VoidToTrace()));
    }
    [_trimVMChain](trace) {
      if (trace == null) dart.nullFailed(I[12], 236, 34, "trace");
  ...
  dart.setLibraryUri(stack_zone_specification.StackZoneSpecification, I[13]);
  ...
  stack_zone_specification._Node = class _Node extends core.Object {
    static ['_#new#tearOff'](trace, previous = null) {
      if (trace == null) dart.nullFailed(I[12], 251, 20, "trace");
  ...
  dart.setLibraryUri(stack_zone_specification._Node, I[13]);
  ...
  var __LazyChain__chain_isSet = dart.privateName(lazy_chain, "_#LazyChain#_chain#isSet");
  ...
  lazy_chain.LazyChain = class LazyChain extends core.Object {
    get [_chain]() {
      let t8;
      if (!dart.test(this[__LazyChain__chain_isSet])) {
        let t7 = this[_thunk$0]();
        if (dart.test(this[__LazyChain__chain_isSet])) dart.throw(new _internal.LateError.fieldADI("_chain"));
        this[__LazyChain__chain] = t7;
        this[__LazyChain__chain_isSet] = true;
      }
      t8 = this[__LazyChain__chain];
      return t8;
    }
    static ['_#new#tearOff'](_thunk) {
      if (_thunk == null) dart.nullFailed(I[14], 20, 18, "_thunk");
    ...
    foldFrames(predicate, opts) {
      if (predicate == null) dart.nullFailed(I[14], 27, 41, "predicate");
      let terse = opts && 'terse' in opts ? opts.terse : false;
      if (terse == null) dart.nullFailed(I[14], 27, 58, "terse");
  ...
  (lazy_chain.LazyChain.new = function(_thunk) {
    ...
    this[__LazyChain__chain_isSet] = false;
  ...
  dart.setLibraryUri(lazy_chain.LazyChain, I[15]);
  dart.setFieldSignature(lazy_chain.LazyChain, () => ({
    ...
    [__LazyChain__chain_isSet]: dart.fieldType(core.bool)
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["trace.dart","vm_trace.dart","frame.dart","unparsed_frame.dart","utils.dart","lazy_trace.dart","chain.dart","stack_zone_specification.dart","lazy_chain.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA