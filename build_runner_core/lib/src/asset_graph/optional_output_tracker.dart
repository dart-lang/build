...
class OptionalOutputTracker {
  ...
  bool isRequired(
    ...
    computedOutputs ??= _assetGraph.computeOutputs();
    ...
    return _checkedOutputs.putIfAbsent(
      output,
      () =>
          (computedOutputs![node.id] ?? <AssetId>{}).any(
          ...
          _assetGraph
              ...
              .map((n) => n.id)
              .any((o) => isRequired(o, currentlyChecking, computedOutputs)),
    );
  }
