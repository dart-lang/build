...
final _sdkJsSourceMapLocation = '$_sdkJsLocation.map';
...
class SdkJsCopyBuilder implements Builder {
  ...
  final buildExtensions = {
    r'$lib$': [
      ...
      'src/dev_compiler/dart_sdk.js.map',
  ...
  FutureOr<void> build(BuildStep buildStep) async {
    ...
    await buildStep.writeAsBytes(
        AssetId('build_web_compilers', 'lib/src/dev_compiler/dart_sdk.js.map'),
        await File(_sdkJsSourceMapLocation).readAsBytes());
    await buildStep.writeAsBytes(
