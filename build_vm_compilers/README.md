...
of [`package:build`][] who want to run code in the Dart vm. Simply add the
...
```dart
    apply(
        'build_modules|vm',
        [
          // These come from the build_modules package, and set up the module
          // structure for your application.
          metaModuleBuilder,
          metaModuleCleanBuilder,
          moduleBuilder,
          // The actual builder which creates modular kernel files for the vm.
